...
| 7 | **57 of 191 matrix entries were a bare "the whole workflow matches its fixture" assertion**, resolving to only 12 fixtures — and at least one cited fixture provably does not contain the feature its test names. | **Open; design superseded.** The fix has evolved past per-entry hand assertions into Java-backed probe pairs ([wfsdk.md](./wfsdk.md), Design 2), which make the vacancy class mechanically impossible. |
