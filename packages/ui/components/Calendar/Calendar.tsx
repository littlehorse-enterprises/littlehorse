...
export function Calendar({ type, changeType, lastDate, changeLastDate, noWindows, changeNoWindows }: CalendarProps) {
  ...
  const setTypeHandler = (e: React.MouseEvent<HTMLDivElement>, type:{ label: string; value: string }) => {
    e.stopPropagation()
    setType(type)
