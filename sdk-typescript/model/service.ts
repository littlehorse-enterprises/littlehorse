...
import { TaskRun, TaskRunSource, VarNameAndVal } from "./task_run";
import {
...
import { ThreadSpec, WfSpec } from "./wf_spec";
...
export interface ListTaskMetricsRequest {
  lastWindowStart: Date | undefined;
  numWindows: number;
  taskDefName: string;
...
function createBasePutWfSpecRequest(): PutWfSpecRequest {
  return { name: "", threadSpecs: {}, entrypointThreadName: "", retentionHours: undefined };
}
...
function createBaseSearchWfRunRequest_StatusAndSpecRequest(): SearchWfRunRequest_StatusAndSpecRequest {
  return { wfSpecName: "", status: 0, wfSpecVersion: 0, earliestStart: undefined, latestStart: undefined };
}
...
export const SearchWfRunRequest_StatusAndSpecRequest = {
  ...
  fromJSON(object: any): SearchWfRunRequest_StatusAndSpecRequest {
    return {
      ...
      earliestStart: isSet(object.earliestStart) ? fromJsonTimestamp(object.earliestStart) : undefined,
      latestStart: isSet(object.latestStart) ? fromJsonTimestamp(object.latestStart) : undefined,
    };
  },
  ...
  toJSON(message: SearchWfRunRequest_StatusAndSpecRequest): unknown {
    ...
    if (message.earliestStart !== undefined) {
      obj.earliestStart = message.earliestStart.toISOString();
    }
    if (message.latestStart !== undefined) {
      obj.latestStart = message.latestStart.toISOString();
    }
    return obj;
  },
...
function createBaseSearchWfRunRequest_StatusAndNameRequest(): SearchWfRunRequest_StatusAndNameRequest {
  return { wfSpecName: "", status: 0, earliestStart: undefined, latestStart: undefined };
}
...
function createBaseSearchTaskRunRequest_StatusAndTaskDefRequest(): SearchTaskRunRequest_StatusAndTaskDefRequest {
  return { status: 0, taskDefName: "", earliestStart: undefined, latestStart: undefined };
}
...
export const TaskWorkerMetadata = {
  ...
  fromJSON(object: any): TaskWorkerMetadata {
    return {
      clientId: isSet(object.clientId) ? String(object.clientId) : "",
      latestHeartbeat: isSet(object.latestHeartbeat) ? fromJsonTimestamp(object.latestHeartbeat) : undefined,
  ...
  toJSON(message: TaskWorkerMetadata): unknown {
    ...
    if (message.latestHeartbeat !== undefined) {
      obj.latestHeartbeat = message.latestHeartbeat.toISOString();
    }
...
function createBaseTaskDefMetricsQueryRequest(): TaskDefMetricsQueryRequest {
  return { windowStart: undefined, windowType: 0, taskDefName: undefined };
}
...
export const TaskDefMetricsQueryRequest = {
  ...
  fromJSON(object: any): TaskDefMetricsQueryRequest {
    return {
      ...
      windowType: isSet(object.windowType) ? metricsWindowLengthFromJSON(object.windowType) : 0,
      taskDefName: isSet(object.taskDefName) ? String(object.taskDefName) : undefined,
    };
  },
...
function createBaseListTaskMetricsRequest(): ListTaskMetricsRequest {
  return { lastWindowStart: undefined, numWindows: 0, taskDefName: "", windowLength: 0 };
}
...
export const ListTaskMetricsRequest = {
  encode(message: ListTaskMetricsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.windowLength !== 0) {
      writer.uint32(32).int32(message.windowLength);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.windowLength = reader.int32() as any;
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ListTaskMetricsRequest {
    return {
      lastWindowStart: isSet(object.lastWindowStart) ? fromJsonTimestamp(object.lastWindowStart) : undefined,
      numWindows: isSet(object.numWindows) ? Number(object.numWindows) : 0,
      taskDefName: isSet(object.taskDefName) ? String(object.taskDefName) : "",
      windowLength: isSet(object.windowLength) ? metricsWindowLengthFromJSON(object.windowLength) : 0,
    };
  },
  ...
  toJSON(message: ListTaskMetricsRequest): unknown {
    const obj: any = {};
    if (message.lastWindowStart !== undefined) {
      obj.lastWindowStart = message.lastWindowStart.toISOString();
    }
    if (message.numWindows !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<ListTaskMetricsRequest>, I>>(object: I): ListTaskMetricsRequest {
    ...
    message.taskDefName = object.taskDefName ?? "";
    message.windowLength = object.windowLength ?? 0;
    return message;
  },
};
...
function createBaseWfSpecMetricsQueryRequest(): WfSpecMetricsQueryRequest {
  return { windowStart: undefined, windowType: 0, wfSpecName: "", wfSpecVersion: 0 };
}
...
function createBaseListWfMetricsRequest(): ListWfMetricsRequest {
  return { lastWindowStart: undefined, numWindows: 0, wfSpecName: "", wfSpecVersion: 0, windowLength: 0 };
}
...
export const ListWfMetricsRequest = {
  encode(message: ListWfMetricsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.windowLength !== 0) {
      writer.uint32(40).int32(message.windowLength);
    }
    return writer;
  },
...
export const TaskDefMetrics = {
  ...
  fromJSON(object: any): TaskDefMetrics {
    return {
      windowStart: isSet(object.windowStart) ? fromJsonTimestamp(object.windowStart) : undefined,
      type: isSet(object.type) ? metricsWindowLengthFromJSON(object.type) : 0,
      taskDefName: isSet(object.taskDefName) ? String(object.taskDefName) : "",
...
export interface LHPublicApi {
  PutTaskDef(request: PutTaskDefRequest): Promise<TaskDef>;
  GetTaskDef(request: TaskDefId): Promise<TaskDef>;
  PutExternalEventDef(request: PutExternalEventDefRequest): Promise<ExternalEventDef>;
  GetExternalEventDef(request: ExternalEventDefId): Promise<ExternalEventDef>;
  PutWfSpec(request: PutWfSpecRequest): Promise<WfSpec>;
  GetWfSpec(request: WfSpecId): Promise<WfSpec>;
  GetLatestWfSpec(request: GetLatestWfSpecRequest): Promise<WfSpec>;
  PutUserTaskDef(request: PutUserTaskDefRequest): Promise<UserTaskDef>;
  GetUserTaskDef(request: UserTaskDefId): Promise<UserTaskDef>;
  GetLatestUserTaskDef(request: GetLatestUserTaskDefRequest): Promise<UserTaskDef>;
  RunWf(request: RunWfRequest): Promise<WfRun>;
  GetWfRun(request: WfRunId): Promise<WfRun>;
  GetUserTaskRun(request: UserTaskRunId): Promise<UserTaskRun>;
  AssignUserTaskRun(request: AssignUserTaskRunRequest): Promise<Empty>;
  CompleteUserTaskRun(request: CompleteUserTaskRunRequest): Promise<Empty>;
  CancelUserTaskRun(request: CancelUserTaskRunRequest): Promise<Empty>;
  ListUserTaskRuns(request: ListUserTaskRunRequest): Promise<UserTaskRunList>;
  GetNodeRun(request: NodeRunId): Promise<NodeRun>;
  ListNodeRuns(request: ListNodeRunsRequest): Promise<NodeRunList>;
  GetTaskRun(request: TaskRunId): Promise<TaskRun>;
  GetVariable(request: VariableId): Promise<Variable>;
  ListVariables(request: ListVariablesRequest): Promise<VariableList>;
  PutExternalEvent(request: PutExternalEventRequest): Promise<ExternalEvent>;
  GetExternalEvent(request: ExternalEventId): Promise<ExternalEvent>;
  ListExternalEvents(request: ListExternalEventsRequest): Promise<ExternalEventList>;
  SearchWfRun(request: SearchWfRunRequest): Promise<WfRunIdList>;
  SearchNodeRun(request: SearchNodeRunRequest): Promise<NodeRunIdList>;
  SearchTaskRun(request: SearchTaskRunRequest): Promise<TaskRunIdList>;
  SearchUserTaskRun(request: SearchUserTaskRunRequest): Promise<UserTaskRunIdList>;
  SearchVariable(request: SearchVariableRequest): Promise<VariableIdList>;
  SearchExternalEvent(request: SearchExternalEventRequest): Promise<ExternalEventIdList>;
  SearchTaskDef(request: SearchTaskDefRequest): Promise<TaskDefIdList>;
  SearchUserTaskDef(request: SearchUserTaskDefRequest): Promise<UserTaskDefIdList>;
  SearchWfSpec(request: SearchWfSpecRequest): Promise<WfSpecIdList>;
  SearchExternalEventDef(request: SearchExternalEventDefRequest): Promise<ExternalEventDefIdList>;
  RegisterTaskWorker(request: RegisterTaskWorkerRequest): Promise<RegisterTaskWorkerResponse>;
  PollTask(request: Observable<PollTaskRequest>): Observable<PollTaskResponse>;
  ReportTask(request: ReportTaskRun): Promise<Empty>;
  StopWfRun(request: StopWfRunRequest): Promise<Empty>;
  ResumeWfRun(request: ResumeWfRunRequest): Promise<Empty>;
  DeleteWfRun(request: DeleteWfRunRequest): Promise<Empty>;
  DeleteTaskDef(request: DeleteTaskDefRequest): Promise<Empty>;
  DeleteWfSpec(request: DeleteWfSpecRequest): Promise<Empty>;
  DeleteUserTaskDef(request: DeleteUserTaskDefRequest): Promise<Empty>;
  DeleteExternalEventDef(request: DeleteExternalEventDefRequest): Promise<Empty>;
  GetTaskDefMetricsWindow(request: TaskDefMetricsQueryRequest): Promise<TaskDefMetrics>;
  GetWfSpecMetricsWindow(request: WfSpecMetricsQueryRequest): Promise<WfSpecMetrics>;
  ListTaskDefMetrics(request: ListTaskMetricsRequest): Promise<ListTaskMetricsResponse>;
  ListWfSpecMetrics(request: ListWfMetricsRequest): Promise<ListWfMetricsResponse>;
}

export const LHPublicApiServiceName = "littlehorse.LHPublicApi";
export class LHPublicApiClientImpl implements LHPublicApi {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || LHPublicApiServiceName;
    this.rpc = rpc;
    this.PutTaskDef = this.PutTaskDef.bind(this);
    this.GetTaskDef = this.GetTaskDef.bind(this);
    this.PutExternalEventDef = this.PutExternalEventDef.bind(this);
    this.GetExternalEventDef = this.GetExternalEventDef.bind(this);
    this.PutWfSpec = this.PutWfSpec.bind(this);
    this.GetWfSpec = this.GetWfSpec.bind(this);
    this.GetLatestWfSpec = this.GetLatestWfSpec.bind(this);
    this.PutUserTaskDef = this.PutUserTaskDef.bind(this);
    this.GetUserTaskDef = this.GetUserTaskDef.bind(this);
    this.GetLatestUserTaskDef = this.GetLatestUserTaskDef.bind(this);
    this.RunWf = this.RunWf.bind(this);
    this.GetWfRun = this.GetWfRun.bind(this);
    this.GetUserTaskRun = this.GetUserTaskRun.bind(this);
    this.AssignUserTaskRun = this.AssignUserTaskRun.bind(this);
    this.CompleteUserTaskRun = this.CompleteUserTaskRun.bind(this);
    this.CancelUserTaskRun = this.CancelUserTaskRun.bind(this);
    this.ListUserTaskRuns = this.ListUserTaskRuns.bind(this);
    this.GetNodeRun = this.GetNodeRun.bind(this);
    this.ListNodeRuns = this.ListNodeRuns.bind(this);
    this.GetTaskRun = this.GetTaskRun.bind(this);
    this.GetVariable = this.GetVariable.bind(this);
    this.ListVariables = this.ListVariables.bind(this);
    this.PutExternalEvent = this.PutExternalEvent.bind(this);
    this.GetExternalEvent = this.GetExternalEvent.bind(this);
    this.ListExternalEvents = this.ListExternalEvents.bind(this);
    this.SearchWfRun = this.SearchWfRun.bind(this);
    this.SearchNodeRun = this.SearchNodeRun.bind(this);
    this.SearchTaskRun = this.SearchTaskRun.bind(this);
    this.SearchUserTaskRun = this.SearchUserTaskRun.bind(this);
    this.SearchVariable = this.SearchVariable.bind(this);
    this.SearchExternalEvent = this.SearchExternalEvent.bind(this);
    this.SearchTaskDef = this.SearchTaskDef.bind(this);
    this.SearchUserTaskDef = this.SearchUserTaskDef.bind(this);
    this.SearchWfSpec = this.SearchWfSpec.bind(this);
    this.SearchExternalEventDef = this.SearchExternalEventDef.bind(this);
    this.RegisterTaskWorker = this.RegisterTaskWorker.bind(this);
    this.PollTask = this.PollTask.bind(this);
    this.ReportTask = this.ReportTask.bind(this);
    this.StopWfRun = this.StopWfRun.bind(this);
    this.ResumeWfRun = this.ResumeWfRun.bind(this);
    this.DeleteWfRun = this.DeleteWfRun.bind(this);
    this.DeleteTaskDef = this.DeleteTaskDef.bind(this);
    this.DeleteWfSpec = this.DeleteWfSpec.bind(this);
    this.DeleteUserTaskDef = this.DeleteUserTaskDef.bind(this);
    this.DeleteExternalEventDef = this.DeleteExternalEventDef.bind(this);
    this.GetTaskDefMetricsWindow = this.GetTaskDefMetricsWindow.bind(this);
    this.GetWfSpecMetricsWindow = this.GetWfSpecMetricsWindow.bind(this);
    this.ListTaskDefMetrics = this.ListTaskDefMetrics.bind(this);
    this.ListWfSpecMetrics = this.ListWfSpecMetrics.bind(this);
  }
  PutTaskDef(request: PutTaskDefRequest): Promise<TaskDef> {
    const data = PutTaskDefRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "PutTaskDef", data);
    return promise.then((data) => TaskDef.decode(_m0.Reader.create(data)));
  }

  GetTaskDef(request: TaskDefId): Promise<TaskDef> {
    const data = TaskDefId.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetTaskDef", data);
    return promise.then((data) => TaskDef.decode(_m0.Reader.create(data)));
  }

  PutExternalEventDef(request: PutExternalEventDefRequest): Promise<ExternalEventDef> {
    const data = PutExternalEventDefRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "PutExternalEventDef", data);
    return promise.then((data) => ExternalEventDef.decode(_m0.Reader.create(data)));
  }

  GetExternalEventDef(request: ExternalEventDefId): Promise<ExternalEventDef> {
    const data = ExternalEventDefId.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetExternalEventDef", data);
    return promise.then((data) => ExternalEventDef.decode(_m0.Reader.create(data)));
  }

  PutWfSpec(request: PutWfSpecRequest): Promise<WfSpec> {
    const data = PutWfSpecRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "PutWfSpec", data);
    return promise.then((data) => WfSpec.decode(_m0.Reader.create(data)));
  }

  GetWfSpec(request: WfSpecId): Promise<WfSpec> {
    const data = WfSpecId.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetWfSpec", data);
    return promise.then((data) => WfSpec.decode(_m0.Reader.create(data)));
  }

  GetLatestWfSpec(request: GetLatestWfSpecRequest): Promise<WfSpec> {
    const data = GetLatestWfSpecRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetLatestWfSpec", data);
    return promise.then((data) => WfSpec.decode(_m0.Reader.create(data)));
  }

  PutUserTaskDef(request: PutUserTaskDefRequest): Promise<UserTaskDef> {
    const data = PutUserTaskDefRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "PutUserTaskDef", data);
    return promise.then((data) => UserTaskDef.decode(_m0.Reader.create(data)));
  }

  GetUserTaskDef(request: UserTaskDefId): Promise<UserTaskDef> {
    const data = UserTaskDefId.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetUserTaskDef", data);
    return promise.then((data) => UserTaskDef.decode(_m0.Reader.create(data)));
  }

  GetLatestUserTaskDef(request: GetLatestUserTaskDefRequest): Promise<UserTaskDef> {
    const data = GetLatestUserTaskDefRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetLatestUserTaskDef", data);
    return promise.then((data) => UserTaskDef.decode(_m0.Reader.create(data)));
  }

  RunWf(request: RunWfRequest): Promise<WfRun> {
    const data = RunWfRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "RunWf", data);
    return promise.then((data) => WfRun.decode(_m0.Reader.create(data)));
  }

  GetWfRun(request: WfRunId): Promise<WfRun> {
    const data = WfRunId.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetWfRun", data);
    return promise.then((data) => WfRun.decode(_m0.Reader.create(data)));
  }

  GetUserTaskRun(request: UserTaskRunId): Promise<UserTaskRun> {
    const data = UserTaskRunId.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetUserTaskRun", data);
    return promise.then((data) => UserTaskRun.decode(_m0.Reader.create(data)));
  }

  AssignUserTaskRun(request: AssignUserTaskRunRequest): Promise<Empty> {
    const data = AssignUserTaskRunRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "AssignUserTaskRun", data);
    return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
  }

  CompleteUserTaskRun(request: CompleteUserTaskRunRequest): Promise<Empty> {
    const data = CompleteUserTaskRunRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CompleteUserTaskRun", data);
    return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
  }

  CancelUserTaskRun(request: CancelUserTaskRunRequest): Promise<Empty> {
    const data = CancelUserTaskRunRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "CancelUserTaskRun", data);
    return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
  }

  ListUserTaskRuns(request: ListUserTaskRunRequest): Promise<UserTaskRunList> {
    const data = ListUserTaskRunRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListUserTaskRuns", data);
    return promise.then((data) => UserTaskRunList.decode(_m0.Reader.create(data)));
  }

  GetNodeRun(request: NodeRunId): Promise<NodeRun> {
    const data = NodeRunId.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetNodeRun", data);
    return promise.then((data) => NodeRun.decode(_m0.Reader.create(data)));
  }

  ListNodeRuns(request: ListNodeRunsRequest): Promise<NodeRunList> {
    const data = ListNodeRunsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListNodeRuns", data);
    return promise.then((data) => NodeRunList.decode(_m0.Reader.create(data)));
  }

  GetTaskRun(request: TaskRunId): Promise<TaskRun> {
    const data = TaskRunId.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetTaskRun", data);
    return promise.then((data) => TaskRun.decode(_m0.Reader.create(data)));
  }

  GetVariable(request: VariableId): Promise<Variable> {
    const data = VariableId.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetVariable", data);
    return promise.then((data) => Variable.decode(_m0.Reader.create(data)));
  }

  ListVariables(request: ListVariablesRequest): Promise<VariableList> {
    const data = ListVariablesRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListVariables", data);
    return promise.then((data) => VariableList.decode(_m0.Reader.create(data)));
  }

  PutExternalEvent(request: PutExternalEventRequest): Promise<ExternalEvent> {
    const data = PutExternalEventRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "PutExternalEvent", data);
    return promise.then((data) => ExternalEvent.decode(_m0.Reader.create(data)));
  }

  GetExternalEvent(request: ExternalEventId): Promise<ExternalEvent> {
    const data = ExternalEventId.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetExternalEvent", data);
    return promise.then((data) => ExternalEvent.decode(_m0.Reader.create(data)));
  }

  ListExternalEvents(request: ListExternalEventsRequest): Promise<ExternalEventList> {
    const data = ListExternalEventsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListExternalEvents", data);
    return promise.then((data) => ExternalEventList.decode(_m0.Reader.create(data)));
  }

  SearchWfRun(request: SearchWfRunRequest): Promise<WfRunIdList> {
    const data = SearchWfRunRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SearchWfRun", data);
    return promise.then((data) => WfRunIdList.decode(_m0.Reader.create(data)));
  }

  SearchNodeRun(request: SearchNodeRunRequest): Promise<NodeRunIdList> {
    const data = SearchNodeRunRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SearchNodeRun", data);
    return promise.then((data) => NodeRunIdList.decode(_m0.Reader.create(data)));
  }

  SearchTaskRun(request: SearchTaskRunRequest): Promise<TaskRunIdList> {
    const data = SearchTaskRunRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SearchTaskRun", data);
    return promise.then((data) => TaskRunIdList.decode(_m0.Reader.create(data)));
  }

  SearchUserTaskRun(request: SearchUserTaskRunRequest): Promise<UserTaskRunIdList> {
    const data = SearchUserTaskRunRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SearchUserTaskRun", data);
    return promise.then((data) => UserTaskRunIdList.decode(_m0.Reader.create(data)));
  }

  SearchVariable(request: SearchVariableRequest): Promise<VariableIdList> {
    const data = SearchVariableRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SearchVariable", data);
    return promise.then((data) => VariableIdList.decode(_m0.Reader.create(data)));
  }

  SearchExternalEvent(request: SearchExternalEventRequest): Promise<ExternalEventIdList> {
    const data = SearchExternalEventRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SearchExternalEvent", data);
    return promise.then((data) => ExternalEventIdList.decode(_m0.Reader.create(data)));
  }

  SearchTaskDef(request: SearchTaskDefRequest): Promise<TaskDefIdList> {
    const data = SearchTaskDefRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SearchTaskDef", data);
    return promise.then((data) => TaskDefIdList.decode(_m0.Reader.create(data)));
  }

  SearchUserTaskDef(request: SearchUserTaskDefRequest): Promise<UserTaskDefIdList> {
    const data = SearchUserTaskDefRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SearchUserTaskDef", data);
    return promise.then((data) => UserTaskDefIdList.decode(_m0.Reader.create(data)));
  }

  SearchWfSpec(request: SearchWfSpecRequest): Promise<WfSpecIdList> {
    const data = SearchWfSpecRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SearchWfSpec", data);
    return promise.then((data) => WfSpecIdList.decode(_m0.Reader.create(data)));
  }

  SearchExternalEventDef(request: SearchExternalEventDefRequest): Promise<ExternalEventDefIdList> {
    const data = SearchExternalEventDefRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SearchExternalEventDef", data);
    return promise.then((data) => ExternalEventDefIdList.decode(_m0.Reader.create(data)));
  }

  RegisterTaskWorker(request: RegisterTaskWorkerRequest): Promise<RegisterTaskWorkerResponse> {
    const data = RegisterTaskWorkerRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "RegisterTaskWorker", data);
    return promise.then((data) => RegisterTaskWorkerResponse.decode(_m0.Reader.create(data)));
  }

  PollTask(request: Observable<PollTaskRequest>): Observable<PollTaskResponse> {
    const data = request.pipe(map((request) => PollTaskRequest.encode(request).finish()));
    const result = this.rpc.bidirectionalStreamingRequest(this.service, "PollTask", data);
    return result.pipe(map((data) => PollTaskResponse.decode(_m0.Reader.create(data))));
  }

  ReportTask(request: ReportTaskRun): Promise<Empty> {
    const data = ReportTaskRun.encode(request).finish();
    const promise = this.rpc.request(this.service, "ReportTask", data);
    return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
  }

  StopWfRun(request: StopWfRunRequest): Promise<Empty> {
    const data = StopWfRunRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "StopWfRun", data);
    return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
  }

  ResumeWfRun(request: ResumeWfRunRequest): Promise<Empty> {
    const data = ResumeWfRunRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ResumeWfRun", data);
    return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
  }

  DeleteWfRun(request: DeleteWfRunRequest): Promise<Empty> {
    const data = DeleteWfRunRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "DeleteWfRun", data);
    return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
  }

  DeleteTaskDef(request: DeleteTaskDefRequest): Promise<Empty> {
    const data = DeleteTaskDefRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "DeleteTaskDef", data);
    return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
  }

  DeleteWfSpec(request: DeleteWfSpecRequest): Promise<Empty> {
    const data = DeleteWfSpecRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "DeleteWfSpec", data);
    return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
  }

  DeleteUserTaskDef(request: DeleteUserTaskDefRequest): Promise<Empty> {
    const data = DeleteUserTaskDefRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "DeleteUserTaskDef", data);
    return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
  }

  DeleteExternalEventDef(request: DeleteExternalEventDefRequest): Promise<Empty> {
    const data = DeleteExternalEventDefRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "DeleteExternalEventDef", data);
    return promise.then((data) => Empty.decode(_m0.Reader.create(data)));
  }

  GetTaskDefMetricsWindow(request: TaskDefMetricsQueryRequest): Promise<TaskDefMetrics> {
    const data = TaskDefMetricsQueryRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetTaskDefMetricsWindow", data);
    return promise.then((data) => TaskDefMetrics.decode(_m0.Reader.create(data)));
  }

  GetWfSpecMetricsWindow(request: WfSpecMetricsQueryRequest): Promise<WfSpecMetrics> {
    const data = WfSpecMetricsQueryRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetWfSpecMetricsWindow", data);
    return promise.then((data) => WfSpecMetrics.decode(_m0.Reader.create(data)));
  }

  ListTaskDefMetrics(request: ListTaskMetricsRequest): Promise<ListTaskMetricsResponse> {
    const data = ListTaskMetricsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListTaskDefMetrics", data);
    return promise.then((data) => ListTaskMetricsResponse.decode(_m0.Reader.create(data)));
  }

  ListWfSpecMetrics(request: ListWfMetricsRequest): Promise<ListWfMetricsResponse> {
    const data = ListWfMetricsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListWfSpecMetrics", data);
    return promise.then((data) => ListWfMetricsResponse.decode(_m0.Reader.create(data)));
  }
}
