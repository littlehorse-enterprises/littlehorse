...
export const VariableMutation = {
  ...
  fromJSON(object: any): VariableMutation {
    return {
      ...
      operation: isSet(object.operation) ? variableMutationTypeFromJSON(object.operation) : 0,
...
function createBaseVariableDef(): VariableDef {
  return { type: 0, name: "", indexType: undefined, jsonIndexes: [], defaultValue: undefined, persistent: false };
}
...
export const VariableDef = {
  encode(message: VariableDef, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.indexType !== undefined) {
      writer.uint32(24).int32(message.indexType);
    }
...
function createBaseUTActionTrigger(): UTActionTrigger {
  return { task: undefined, cancel: undefined, reassign: undefined, delaySeconds: undefined, hook: 0 };
}
...
export const UTActionTrigger = {
  encode(message: UTActionTrigger, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.hook !== 0) {
      writer.uint32(48).int32(message.hook);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.hook = reader.int32() as any;
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): UTActionTrigger {
    return {
      ...
      hook: isSet(object.hook) ? uTActionTrigger_UTHookFromJSON(object.hook) : 0,
    };
  },
