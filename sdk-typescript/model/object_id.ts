...
import { MetricsWindowLength, metricsWindowLengthFromJSON, metricsWindowLengthToJSON } from "./common_enums";
...
function createBaseTaskDefMetricsId(): TaskDefMetricsId {
  return { windowStart: undefined, windowType: 0, taskDefName: "" };
}
