...
const enforcePropsInterfaceNamingRule = {
  "enforce-props-interface-naming": {
    meta: {
      ...
      docs: {
        description:
          "Enforce that React component prop interfaces follow the naming convention {ComponentName}Props",
...
const noClientPagesRule = {
  "no-client-pages": {
    meta: {
      ...
      docs: {
        description:
          "Prevent the use of 'use client'; directive in page.tsx and page.ts files",
        category: "Best Practices",
      },
      messages: {
        noClientDirective:
          "Pages cannot be client components. Remove 'use client'; directive from page files.",
      },
    },
    create(context) {
      return {
