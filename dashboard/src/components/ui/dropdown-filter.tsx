...
export function DropdownFilter({
    ...
    options,
    labelText,
    icon = <Filter className="h-3.5 w-3.5 text-muted-foreground/70" />,
    ...
    const [selectedValues, setSelectedValues] = useState<Set<string>>(
        selectionMode === "multiple" && Array.isArray(initialSelected)
    ...
    const [selectedValue, setSelectedValue] = useState<string>(
        selectionMode === "single" && typeof initialSelected === "string"
            ? initialSelected
            : options[0]?.value || ""
    )
    ...
    const isFilterActive = selectionMode === "multiple"
