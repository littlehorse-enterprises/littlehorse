      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        <div className="space-y-2 p-2">
          {threadSpecsWithVariableDefs.map(([threadName, threadSpec]) => {
            return <Fragment key={threadName}>
              <div className="sticky top-0 z-10 bg-gray-50 border-b rounded-md border-gray-300  p-2 text-xs">
                <span className="font-medium">{threadName}</span>
              </div>
