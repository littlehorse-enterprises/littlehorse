...
export const AccordionItem: FC<{ node: NodeRun }> = ({ node }) => {
  const nodeType = getNodeType(node)
  const Component = AccordionComponents[nodeType]
  return (
      <AccordionRedux.Item value={`item-${node.id}`} className="overflow-hidden rounded-lg border">
