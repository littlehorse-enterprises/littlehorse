...
const baseClasses = "h-5 p-2 border border-gray-500 rounded-md mb-2.5 flex justify-center items-center cursor-grab touch-none bg-gray-700 text-xs whitespace-nowrap active:cursor-grabbing";
