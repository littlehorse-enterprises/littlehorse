    ...
    <Card className="bg-gray-900 border-gray-700 text-white">
      ...
      <CardContent>
        ...
        {isEditing ? (
          ...
          <Button onClick={handleCancel} className="mt-2">Cancel</Button>
          </>
        ) : (
          <>
          <Button onClick={startEditing} className="mr-2">Edit</Button>
          <Button onClick={() => handleDelete(node.id)} className="mt-2">Delete</Button>
          </>
        )}
      </CardContent>
    </Card>
