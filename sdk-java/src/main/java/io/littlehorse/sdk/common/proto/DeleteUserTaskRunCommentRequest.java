...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      DeleteUserTaskRunCommentRequest.class.getName());
  }
  // Use DeleteUserTaskRunCommentRequest.newBuilder() to construct.
  private DeleteUserTaskRunCommentRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (userCommentId_ != 0) {
      output.writeInt32(2, userCommentId_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (userCommentId_ != 0) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt32Size(2, userCommentId_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(userId_)) {
