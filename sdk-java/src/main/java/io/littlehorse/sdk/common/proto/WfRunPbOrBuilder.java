...
public interface WfRunPbOrBuilder extends
   ...
   */
  java.util.List<io.littlehorse.sdk.common.proto.ThreadRunPb> 
      getThreadRunsList();
  /**
   * <code>repeated .littlehorse.ThreadRunPb thread_runs = 8;</code>
   */
  io.littlehorse.sdk.common.proto.ThreadRunPb getThreadRuns(int index);
  /**
   * <code>repeated .littlehorse.ThreadRunPb thread_runs = 8;</code>
   */
   ...
   * <code>repeated .littlehorse.ThreadRunPb thread_runs = 8;</code>
   */
  java.util.List<? extends io.littlehorse.sdk.common.proto.ThreadRunPbOrBuilder> 
      getThreadRunsOrBuilderList();
  /**
   * <code>repeated .littlehorse.ThreadRunPb thread_runs = 8;</code>
   */
  io.littlehorse.sdk.common.proto.ThreadRunPbOrBuilder getThreadRunsOrBuilder(
      int index);
