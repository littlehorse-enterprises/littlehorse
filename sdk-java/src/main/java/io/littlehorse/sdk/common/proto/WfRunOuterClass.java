...
public final class WfRunOuterClass {
  ...
  static {
    ...
    internal_static_littlehorse_WfRun_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_littlehorse_WfRun_descriptor,
        new java.lang.String[] { "Id", "WfSpecId", "OldWfSpecVersions", "Status", "GreatestThreadrunNumber", "StartTime", "EndTime", "ThreadRuns", "PendingInterrupts", "PendingFailures", "EndTime", });
    internal_static_littlehorse_ThreadRun_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_littlehorse_ThreadRun_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_littlehorse_ThreadRun_descriptor,
        new java.lang.String[] { "WfSpecId", "Number", "Status", "ThreadSpecName", "StartTime", "EndTime", "ErrorMessage", "ChildThreadIds", "ParentThreadId", "HaltReasons", "InterruptTriggerId", "FailureBeingHandled", "CurrentNodePosition", "HandledFailedChildren", "Type", "Output", "EndTime", "ErrorMessage", "ParentThreadId", "InterruptTriggerId", "FailureBeingHandled", "Output", });
    internal_static_littlehorse_FailureBeingHandled_descriptor =
