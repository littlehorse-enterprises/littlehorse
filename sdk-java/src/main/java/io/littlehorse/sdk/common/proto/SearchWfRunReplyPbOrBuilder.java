...
public interface SearchWfRunReplyPbOrBuilder extends
   ...
   */
  java.util.List<io.littlehorse.sdk.common.proto.WfRunIdPb> 
      getResultsList();
  /**
   * <code>repeated .littlehorse.WfRunIdPb results = 3;</code>
   */
  io.littlehorse.sdk.common.proto.WfRunIdPb getResults(int index);
  /**
   * <code>repeated .littlehorse.WfRunIdPb results = 3;</code>
   */
  int getResultsCount();
   ...
   * <code>repeated .littlehorse.WfRunIdPb results = 3;</code>
   */
  java.util.List<? extends io.littlehorse.sdk.common.proto.WfRunIdPbOrBuilder> 
      getResultsOrBuilderList();
  /**
   * <code>repeated .littlehorse.WfRunIdPb results = 3;</code>
   */
  io.littlehorse.sdk.common.proto.WfRunIdPbOrBuilder getResultsOrBuilder(
      int index);
