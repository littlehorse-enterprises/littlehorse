...
public interface WorkflowEventDefIdListOrBuilder extends
    // @@protoc_insertion_point(interface_extends:littlehorse.WorkflowEventDefIdList)
   ...
   * <code>repeated .littlehorse.WorkflowEventDefId results = 1;</code>
   */
  io.littlehorse.sdk.common.proto.WorkflowEventDefId getResults(int index);
  /**
   * <pre>
   * The resulting object id's.
   * </pre>
   ...
   * <code>repeated .littlehorse.WorkflowEventDefId results = 1;</code>
   */
  io.littlehorse.sdk.common.proto.WorkflowEventDefIdOrBuilder getResultsOrBuilder(
      int index);
