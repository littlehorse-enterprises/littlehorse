...
public final class LittleHorseGrpc {
  ...
  private static final int METHODID_SEARCH_CORRELATED_EVENT = 43;
  private static final int METHODID_SEARCH_NODE_RUN = 44;
  private static final int METHODID_SEARCH_TASK_RUN = 45;
  private static final int METHODID_SEARCH_USER_TASK_RUN = 46;
  private static final int METHODID_SEARCH_VARIABLE = 47;
  private static final int METHODID_SEARCH_EXTERNAL_EVENT = 48;
  private static final int METHODID_SEARCH_WORKFLOW_EVENT = 49;
  private static final int METHODID_SEARCH_TASK_DEF = 50;
  private static final int METHODID_SEARCH_USER_TASK_DEF = 51;
  private static final int METHODID_SEARCH_WF_SPEC = 52;
  private static final int METHODID_SEARCH_EXTERNAL_EVENT_DEF = 53;
  private static final int METHODID_SEARCH_WORKFLOW_EVENT_DEF = 54;
  private static final int METHODID_SEARCH_TENANT = 55;
  private static final int METHODID_SEARCH_PRINCIPAL = 56;
  private static final int METHODID_REGISTER_TASK_WORKER = 57;
  private static final int METHODID_REPORT_TASK = 58;
  private static final int METHODID_STOP_WF_RUN = 59;
  private static final int METHODID_RESUME_WF_RUN = 60;
  private static final int METHODID_RESCUE_THREAD_RUN = 61;
  private static final int METHODID_DELETE_WF_RUN = 62;
  private static final int METHODID_DELETE_TASK_DEF = 63;
  private static final int METHODID_DELETE_STRUCT_DEF = 64;
  private static final int METHODID_DELETE_WF_SPEC = 65;
  private static final int METHODID_DELETE_USER_TASK_DEF = 66;
  private static final int METHODID_DELETE_EXTERNAL_EVENT_DEF = 67;
  private static final int METHODID_DELETE_CORRELATED_EVENT = 68;
  private static final int METHODID_DELETE_WORKFLOW_EVENT_DEF = 69;
  private static final int METHODID_DELETE_PRINCIPAL = 70;
  private static final int METHODID_DELETE_SCHEDULED_WF_RUN = 71;
  private static final int METHODID_GET_TASK_DEF_METRICS_WINDOW = 72;
  private static final int METHODID_GET_WF_SPEC_METRICS_WINDOW = 73;
  private static final int METHODID_LIST_TASK_DEF_METRICS = 74;
  private static final int METHODID_LIST_WF_SPEC_METRICS = 75;
  private static final int METHODID_PUT_TENANT = 76;
  private static final int METHODID_GET_TENANT = 77;
  private static final int METHODID_PUT_PRINCIPAL = 78;
  private static final int METHODID_GET_PRINCIPAL = 79;
  private static final int METHODID_WHOAMI = 80;
  private static final int METHODID_GET_SERVER_VERSION = 81;
  private static final int METHODID_POLL_TASK = 82;
