...
public final class LittleHorseGrpc {
  ...
  private static final int METHODID_STOP_WF_RUN = 64;
  private static final int METHODID_RESUME_WF_RUN = 65;
  private static final int METHODID_RESCUE_THREAD_RUN = 66;
  private static final int METHODID_DELETE_WF_RUN = 67;
  private static final int METHODID_DELETE_TASK_DEF = 68;
  private static final int METHODID_DELETE_STRUCT_DEF = 69;
  private static final int METHODID_DELETE_WF_SPEC = 70;
  private static final int METHODID_DELETE_USER_TASK_DEF = 71;
  private static final int METHODID_DELETE_EXTERNAL_EVENT_DEF = 72;
  private static final int METHODID_DELETE_CORRELATED_EVENT = 73;
  private static final int METHODID_DELETE_WORKFLOW_EVENT_DEF = 74;
  private static final int METHODID_DELETE_PRINCIPAL = 75;
  private static final int METHODID_DELETE_SCHEDULED_WF_RUN = 76;
  private static final int METHODID_GET_TASK_DEF_METRICS_WINDOW = 77;
  private static final int METHODID_GET_WF_SPEC_METRICS_WINDOW = 78;
  private static final int METHODID_LIST_TASK_DEF_METRICS = 79;
  private static final int METHODID_LIST_WF_SPEC_METRICS = 80;
  private static final int METHODID_PUT_TENANT = 81;
  private static final int METHODID_GET_TENANT = 82;
  private static final int METHODID_PUT_PRINCIPAL = 83;
  private static final int METHODID_GET_PRINCIPAL = 84;
  private static final int METHODID_WHOAMI = 85;
  private static final int METHODID_GET_SERVER_VERSION = 86;
  private static final int METHODID_LIST_METRIC_SPECS = 87;
