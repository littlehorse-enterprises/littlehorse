...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      VariableAssignment.class.getName());
  }
  // Use VariableAssignment.newBuilder() to construct.
  private VariableAssignment(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        FormatString.class.getName());
    }
    // Use FormatString.newBuilder() to construct.
    private FormatString(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        NodeOutputReference.class.getName());
    }
    // Use NodeOutputReference.newBuilder() to construct.
    private NodeOutputReference(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage
                .alwaysUseFieldBuilders) {
          internalGetLhsFieldBuilder();
          internalGetRhsFieldBuilder();
        }
      }
      @java.lang.Override
      public Builder clear() {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10: {
                input.readMessage(
                    internalGetLhsFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 10
      ...
      public io.littlehorse.sdk.common.proto.VariableAssignment.Builder getLhsBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
        return internalGetLhsFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * The left-hand-side of the expression.
  ...
  public static final class Builder extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              input.readMessage(
                  internalGetFormatStringFieldBuilder().getBuilder(),
                  extensionRegistry);
              sourceCase_ = 4;
              break;
            } // case 34
    ...
    public io.littlehorse.sdk.common.proto.VariableAssignment.FormatString.Builder getFormatStringBuilder() {
      return internalGetFormatStringFieldBuilder().getBuilder();
    }
    /**
     * <pre>
     * Assign a format string
    ...
    private com.google.protobuf.SingleFieldBuilder<
        ...
        internalGetFormatStringFieldBuilder() {
      if (formatStringBuilder_ == null) {
        if (!(sourceCase_ == 4)) {
          source_ = io.littlehorse.sdk.common.proto.VariableAssignment.FormatString.getDefaultInstance();
        }
        formatStringBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            io.littlehorse.sdk.common.proto.VariableAssignment.FormatString, io.littlehorse.sdk.common.proto.VariableAssignment.FormatString.Builder, io.littlehorse.sdk.common.proto.VariableAssignment.FormatStringOrBuilder>(
