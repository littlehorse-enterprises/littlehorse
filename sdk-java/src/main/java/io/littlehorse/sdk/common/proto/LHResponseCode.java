...
/**
 * Protobuf enum {@code littlehorse.LHResponseCode}
 */
public enum LHResponseCode
  ...
  public static LHResponseCode valueOf(int value) {
   ...
   * @return The enum associated with the given numeric wire value.
   */
  public static LHResponseCode forNumber(int value) {
    switch (value) {
      case 0: return OK;
  ...
  public static com.google.protobuf.Internal.EnumLiteMap<LHResponseCode>
      internalGetValueMap() {
    return internalValueMap;
  }
  private static final com.google.protobuf.Internal.EnumLiteMap<
      LHResponseCode> internalValueMap =
        new com.google.protobuf.Internal.EnumLiteMap<LHResponseCode>() {
          public LHResponseCode findValueByNumber(int number) {
            return LHResponseCode.forNumber(number);
          }
        };
  ...
  private static final LHResponseCode[] VALUES = values();

  public static LHResponseCode valueOf(
  ...
  private LHResponseCode(int value) {
    this.value = value;
  }

  // @@protoc_insertion_point(enum_scope:littlehorse.LHResponseCode)
}
