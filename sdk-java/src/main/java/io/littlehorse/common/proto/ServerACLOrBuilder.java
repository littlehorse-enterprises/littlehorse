...
public interface ServerACLOrBuilder extends
   ...
   */
  java.util.List<io.littlehorse.common.proto.ACLResource> getResourcesList();
  /**
   * <code>repeated .littlehorse.ACLResource resources = 1;</code>
   ...
   */
  io.littlehorse.common.proto.ACLResource getResources(int index);
  /**
   * <code>repeated .littlehorse.ACLResource resources = 1;</code>
   ...
   */
  java.util.List<io.littlehorse.common.proto.ACLAction> getAllowedActionsList();
  /**
   * <code>repeated .littlehorse.ACLAction allowed_actions = 2;</code>
   ...
   */
  io.littlehorse.common.proto.ACLAction getAllowedActions(int index);
  /**
   * <code>repeated .littlehorse.ACLAction allowed_actions = 2;</code>
  ...
  io.littlehorse.common.proto.ServerACL.ResourceFilterCase getResourceFilterCase();
}
