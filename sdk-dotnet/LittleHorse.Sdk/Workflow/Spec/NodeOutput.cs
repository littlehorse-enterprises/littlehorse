...
public class NodeOutput
{
    ...
    /// <summary>
    /// Returns a CastExpression representing this node output cast to the specified target type.
    /// </summary>
    /// <param name="targetType">The VariableType to cast this output to.</param>
    /// <returns>A CastExpression wrapping this node output.</returns>
