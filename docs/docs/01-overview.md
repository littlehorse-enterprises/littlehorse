...
The code for the LittleHorse Server and all clients is available at [our github](https://github.com/littlehorse-enterprises/littlehorse). All code is free for production use under the Server-Side Public License. 
