...
async function main() {
  const workers = [
    createTaskWorker(task1, 'task-1', config, { inputVars: {} }),
    createTaskWorker(task2, 'task-2', config, { inputVars: {} }),
    createTaskWorker(task3, 'task-3', config, { inputVars: {} }),
    createTaskWorker(task4, 'task-4', config, { inputVars: {} }),
  ]
