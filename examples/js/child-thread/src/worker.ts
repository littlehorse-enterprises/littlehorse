...
async function main() {
  const workers = [
    ...
    createTaskWorker(childTask2, 'child-task-2', config, {
      inputVars: {},
    ...
    createTaskWorker(parentTask2, 'parent-task-2', config, {
      inputVars: {},
      outputSchema: z.string(),
    }),
  ]
  ...
  console.log('ready: polling for parent-task-1, child-task-1, child-task-2, grandchild-task, parent-task-2 tasks')
