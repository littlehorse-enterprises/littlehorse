...
/**
 * Represents the search scan boundary mechanism to be utilized in the Search by {@link
 * io.littlehorse.server.streamsimpl.BackendInternalComms#doScan(InternalScan)} method.
 */
