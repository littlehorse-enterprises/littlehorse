...
import io.littlehorse.common.model.metadatacommand.subcommand.*;
...
import io.littlehorse.server.streams.lhinternalscan.publicrequests.*;
import io.littlehorse.server.streams.lhinternalscan.publicsearchreplies.*;
...
public class KafkaStreamsServerImpl extends LittleHorseImplBase {
    ...
    public void searchTenant(SearchTenantRequest req, StreamObserver<TenantIdList> ctx) {
        handleScan(
                SearchTenantRequestModel.fromProto(req, requestContext()),
                ctx,
                SearchTenantRequestReply.class);
    }
