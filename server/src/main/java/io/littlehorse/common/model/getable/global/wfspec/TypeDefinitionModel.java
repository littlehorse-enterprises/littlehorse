...
public class TypeDefinitionModel extends LHSerializable<TypeDefinition> {
    ...
    public StructDefIdModel getStructDefId() {
        return this.structDefId;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TypeDefinitionModel)) return false;
        final TypeDefinitionModel other = (TypeDefinitionModel) o;
        if (!other.canEqual((Object) this)) return false;
        if (this.isMasked() != other.isMasked()) return false;
        final Object this$definedTypeCase = this.getDefinedTypeCase();
        final Object other$definedTypeCase = other.getDefinedTypeCase();
        if (this$definedTypeCase == null
                ? other$definedTypeCase != null
                : !this$definedTypeCase.equals(other$definedTypeCase)) return false;
        final Object this$primitiveType = this.getPrimitiveType();
        final Object other$primitiveType = other.getPrimitiveType();
        if (this$primitiveType == null ? other$primitiveType != null : !this$primitiveType.equals(other$primitiveType))
            return false;
        final Object this$structDefId = this.getStructDefId();
        final Object other$structDefId = other.getStructDefId();
        if (this$structDefId == null ? other$structDefId != null : !this$structDefId.equals(other$structDefId))
            return false;
        final Object this$inlineArrayDef = this.getInlineArrayDef();
        final Object other$inlineArrayDef = other.getInlineArrayDef();
        if (this$inlineArrayDef == null
                ? other$inlineArrayDef != null
                : !this$inlineArrayDef.equals(other$inlineArrayDef)) return false;
        return true;
    }

    protected boolean canEqual(final Object other) {
        return other instanceof TypeDefinitionModel;
    }
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        result = result * PRIME + (this.isMasked() ? 79 : 97);
        final Object $definedTypeCase = this.getDefinedTypeCase();
        result = result * PRIME + ($definedTypeCase == null ? 43 : $definedTypeCase.hashCode());
        final Object $primitiveType = this.getPrimitiveType();
        result = result * PRIME + ($primitiveType == null ? 43 : $primitiveType.hashCode());
        final Object $structDefId = this.getStructDefId();
        result = result * PRIME + ($structDefId == null ? 43 : $structDefId.hashCode());
        final Object $inlineArrayDef = this.getInlineArrayDef();
        result = result * PRIME + ($inlineArrayDef == null ? 43 : $inlineArrayDef.hashCode());
        return result;
    }
}
