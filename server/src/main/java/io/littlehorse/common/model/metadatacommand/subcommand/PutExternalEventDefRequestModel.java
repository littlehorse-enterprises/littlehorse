...
public class PutExternalEventDefRequestModel extends MetadataSubCommand<PutExternalEventDefRequest> {
    ...
    public ExternalEventDef process(ExecutionContext dao, LHServerConfig config) {
    ...
    public static PutExternalEventDefRequestModel fromProto(PutExternalEventDefRequest p, io.littlehorse.server.streams.topology.core.ExecutionContext context) {
