...
public class UTECommentEditedModel extends LHSerializable<UTECommented> {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UTECommentEditedModel)) return false;
        final UTECommentEditedModel other = (UTECommentEditedModel) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UTECommentEditedModel;
    }
    ...
    public String toString() {
        return "UTECommentEditedModel(userCommentId=" + this.getUserCommentId() + ", userId=" + this.getUserId()
