...
public class ThreadRunIterator implements Iterator<ThreadRunModel> {
  ...
  public ThreadRunIterator(WfRunIdModel wfRunId, List<ThreadRunModel> threadRuns, int maxThreadRunNumber, GetableManager getableManager) {
  ...
  public ThreadRunModel next() {
    ...
    ArchivedThreadRunModel potentialThreadRun = getableManager.get(new ArchivedThreadRunIdModel(this.wfRunId, currentIndex));
