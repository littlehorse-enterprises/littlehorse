...
import { InlineStructDef, ReturnType, VariableAssignment, VariableDef } from "./common_wfspec";
import {
  CorrelatedEvent,
...
import { ThreadMigrationPlan, WfRunMigrationPlan } from "./wf_run_migration";
import {
  ThreadSpec,
  WfSpec,
...
export function structDefCompatibilityTypeToJSON(object: StructDefCompatibilityType): string {
  switch (object) {
    case StructDefCompatibilityType.NO_SCHEMA_UPDATES:
      return "NO_SCHEMA_UPDATES";
    case StructDefCompatibilityType.FULLY_COMPATIBLE_SCHEMA_UPDATES:
      return "FULLY_COMPATIBLE_SCHEMA_UPDATES";
...
export interface SearchWfSpecRequest {
  ...
  /** Maximum results to return in one request. */
  limit?: number | undefined;
  wfSpecCriteria?: { $case: "name"; value: string } | { $case: "prefix"; value: string } | {
    $case: "taskDefName";
    value: string;
  } | undefined;
}
...
export interface PutMigrationPlanRequest {
  name: string;
  migrationPlan: { [key: string]: ThreadMigrationPlan };
  newWfSpec: WfSpecId | undefined;
}

export interface PutMigrationPlanRequest_MigrationPlanEntry {
  key: string;
...
export interface MigrationVariables {
  /** var name -> var Value */
  varValues: { [key: string]: VariableAssignment };
}
...
export const PutStructDefRequest = {
  ...
  toJSON(message: PutStructDefRequest): unknown {
    ...
    if (message.allowedUpdates !== StructDefCompatibilityType.NO_SCHEMA_UPDATES) {
      obj.allowedUpdates = structDefCompatibilityTypeToJSON(message.allowedUpdates);
    }
    return obj;
  },
...
export const ValidateStructDefEvolutionRequest = {
  ...
  fromJSON(object: any): ValidateStructDefEvolutionRequest {
    return {
      structDefId: isSet(object.structDefId) ? StructDefId.fromJSON(object.structDefId) : undefined,
      structDef: isSet(object.structDef) ? InlineStructDef.fromJSON(object.structDef) : undefined,
      compatibilityType: isSet(object.compatibilityType)
        ? structDefCompatibilityTypeFromJSON(object.compatibilityType)
        : StructDefCompatibilityType.NO_SCHEMA_UPDATES,
    };
  },

  toJSON(message: ValidateStructDefEvolutionRequest): unknown {
    const obj: any = {};
    if (message.structDefId !== undefined) {
    ...
    if (message.compatibilityType !== StructDefCompatibilityType.NO_SCHEMA_UPDATES) {
      obj.compatibilityType = structDefCompatibilityTypeToJSON(message.compatibilityType);
    }
    return obj;
  },
...
export const ValidateStructDefEvolutionResponse = {
  ...
  fromJSON(object: any): ValidateStructDefEvolutionResponse {
    return { isValid: isSet(object.isValid) ? globalThis.Boolean(object.isValid) : false };
  },

  toJSON(message: ValidateStructDefEvolutionResponse): unknown {
    const obj: any = {};
    if (message.isValid !== false) {
...
export const PutWorkflowEventDefRequest = {
  ...
  fromJSON(object: any): PutWorkflowEventDefRequest {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      contentType: isSet(object.contentType) ? ReturnType.fromJSON(object.contentType) : undefined,
    };
  },
  ...
  toJSON(message: PutWorkflowEventDefRequest): unknown {
    ...
    if (message.contentType !== undefined) {
      obj.contentType = ReturnType.toJSON(message.contentType);
    }
    return obj;
  },
...
export const PutCorrelatedEventRequest = {
  ...
  fromJSON(object: any): PutCorrelatedEventRequest {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      externalEventDefId: isSet(object.externalEventDefId)
        ? ExternalEventDefId.fromJSON(object.externalEventDefId)
  ...
  toJSON(message: PutCorrelatedEventRequest): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
...
export const DeleteScheduledWfRunRequest = {
  ...
  fromJSON(object: any): DeleteScheduledWfRunRequest {
    return { id: isSet(object.id) ? ScheduledWfRunId.fromJSON(object.id) : undefined };
  },

  toJSON(message: DeleteScheduledWfRunRequest): unknown {
    const obj: any = {};
    if (message.id !== undefined) {
...
export const DeleteCorrelatedEventRequest = {
  ...
  fromJSON(object: any): DeleteCorrelatedEventRequest {
    return { id: isSet(object.id) ? CorrelatedEventId.fromJSON(object.id) : undefined };
  },

  toJSON(message: DeleteCorrelatedEventRequest): unknown {
    const obj: any = {};
    if (message.id !== undefined) {
...
export const DeleteStructDefRequest = {
  ...
  fromJSON(object: any): DeleteStructDefRequest {
    return { id: isSet(object.id) ? StructDefId.fromJSON(object.id) : undefined };
  },

  toJSON(message: DeleteStructDefRequest): unknown {
    const obj: any = {};
    if (message.id !== undefined) {
...
export const DeleteWorkflowEventDefRequest = {
  ...
  fromJSON(object: any): DeleteWorkflowEventDefRequest {
    return { id: isSet(object.id) ? WorkflowEventDefId.fromJSON(object.id) : undefined };
  },

  toJSON(message: DeleteWorkflowEventDefRequest): unknown {
    const obj: any = {};
    if (message.id !== undefined) {
...
export const ScheduleWfRequest = {
  ...
  fromJSON(object: any): ScheduleWfRequest {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : undefined,
      wfSpecName: isSet(object.wfSpecName) ? globalThis.String(object.wfSpecName) : "",
      majorVersion: isSet(object.majorVersion) ? globalThis.Number(object.majorVersion) : undefined,
  ...
  toJSON(message: ScheduleWfRequest): unknown {
    const obj: any = {};
    if (message.id !== undefined) {
      obj.id = message.id;
    }
...
export const ScheduleWfRequest_VariablesEntry = {
  ...
  fromJSON(object: any): ScheduleWfRequest_VariablesEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? VariableValue.fromJSON(object.value) : undefined,
    };
  ...
  toJSON(message: ScheduleWfRequest_VariablesEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
...
export const SearchCorrelatedEventRequest = {
  ...
  fromJSON(object: any): SearchCorrelatedEventRequest {
    return {
      bookmark: isSet(object.bookmark) ? Buffer.from(bytesFromBase64(object.bookmark)) : undefined,
      limit: isSet(object.limit) ? globalThis.Number(object.limit) : undefined,
      earliestStart: isSet(object.earliestStart) ? globalThis.String(object.earliestStart) : undefined,
      ...
      externalEventDefId: isSet(object.externalEventDefId)
        ? ExternalEventDefId.fromJSON(object.externalEventDefId)
        : undefined,
      hasExternalEvents: isSet(object.hasExternalEvents) ? globalThis.Boolean(object.hasExternalEvents) : undefined,
    };
  },

  toJSON(message: SearchCorrelatedEventRequest): unknown {
    const obj: any = {};
    if (message.bookmark !== undefined) {
      obj.bookmark = base64FromBytes(message.bookmark);
    }
    ...
    if (message.hasExternalEvents !== undefined) {
      obj.hasExternalEvents = message.hasExternalEvents;
    }
    return obj;
  },
...
export const CorrelatedEventIdList = {
  ...
  fromJSON(object: any): CorrelatedEventIdList {
    return {
      results: globalThis.Array.isArray(object?.results)
        ? object.results.map((e: any) => CorrelatedEventId.fromJSON(e))
        : [],
      bookmark: isSet(object.bookmark) ? Buffer.from(bytesFromBase64(object.bookmark)) : undefined,
    };
  },

  toJSON(message: CorrelatedEventIdList): unknown {
    const obj: any = {};
    if (message.results?.length) {
      obj.results = message.results.map((e) => CorrelatedEventId.toJSON(e));
    }
    if (message.bookmark !== undefined) {
      obj.bookmark = base64FromBytes(message.bookmark);
    }
...
export const SearchNodeRunRequest = {
  ...
  fromJSON(object: any): SearchNodeRunRequest {
    return {
      ...
      externalEventDef: isSet(object.externalEventDef)
        ? ExternalEventDefId.fromJSON(object.externalEventDef)
        : undefined,
    };
  },
  ...
  toJSON(message: SearchNodeRunRequest): unknown {
    ...
    if (message.externalEventDef !== undefined) {
      obj.externalEventDef = ExternalEventDefId.toJSON(message.externalEventDef);
    }
    return obj;
  },
...
export const SearchUserTaskDefRequest = {
  encode(message: SearchUserTaskDefRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    switch (message.userTaskDefCriteria?.$case) {
      case "prefix":
        writer.uint32(26).string(message.userTaskDefCriteria.value);
        break;
      case "name":
        writer.uint32(34).string(message.userTaskDefCriteria.value);
        break;
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.userTaskDefCriteria = { $case: "prefix", value: reader.string() };
          continue;
        case 4:
          if (tag !== 34) {
            break;
          ...
          message.userTaskDefCriteria = { $case: "name", value: reader.string() };
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): SearchUserTaskDefRequest {
    return {
      bookmark: isSet(object.bookmark) ? Buffer.from(bytesFromBase64(object.bookmark)) : undefined,
      limit: isSet(object.limit) ? globalThis.Number(object.limit) : undefined,
      userTaskDefCriteria: isSet(object.prefix)
  ...
  toJSON(message: SearchUserTaskDefRequest): unknown {
    ...
    if (message.userTaskDefCriteria?.$case === "prefix") {
      obj.prefix = message.userTaskDefCriteria.value;
    }
    if (message.userTaskDefCriteria?.$case === "name") {
      obj.name = message.userTaskDefCriteria.value;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<SearchUserTaskDefRequest>): SearchUserTaskDefRequest {
    ...
    if (
      ...
      object.userTaskDefCriteria?.value !== undefined &&
      object.userTaskDefCriteria?.value !== null
    ) {
      message.userTaskDefCriteria = { $case: "prefix", value: object.userTaskDefCriteria.value };
    }
    if (
...
export const SearchWfSpecRequest = {
  encode(message: SearchWfSpecRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    switch (message.wfSpecCriteria?.$case) {
      case "name":
        writer.uint32(26).string(message.wfSpecCriteria.value);
        break;
      case "prefix":
        writer.uint32(34).string(message.wfSpecCriteria.value);
        break;
      case "taskDefName":
        writer.uint32(42).string(message.wfSpecCriteria.value);
        break;
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.wfSpecCriteria = { $case: "name", value: reader.string() };
          continue;
        case 4:
          if (tag !== 34) {
            break;
          ...
          message.wfSpecCriteria = { $case: "prefix", value: reader.string() };
          continue;
        case 5:
          if (tag !== 42) {
            break;
          ...
          message.wfSpecCriteria = { $case: "taskDefName", value: reader.string() };
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): SearchWfSpecRequest {
    return {
      bookmark: isSet(object.bookmark) ? Buffer.from(bytesFromBase64(object.bookmark)) : undefined,
      limit: isSet(object.limit) ? globalThis.Number(object.limit) : undefined,
      wfSpecCriteria: isSet(object.name)
        ? { $case: "name", value: globalThis.String(object.name) }
        : isSet(object.prefix)
        ? { $case: "prefix", value: globalThis.String(object.prefix) }
        : isSet(object.taskDefName)
        ? { $case: "taskDefName", value: globalThis.String(object.taskDefName) }
        : undefined,
    };
  },
  ...
  toJSON(message: SearchWfSpecRequest): unknown {
    ...
    if (message.wfSpecCriteria?.$case === "name") {
      obj.name = message.wfSpecCriteria.value;
    }
    if (message.wfSpecCriteria?.$case === "prefix") {
      obj.prefix = message.wfSpecCriteria.value;
    }
    if (message.wfSpecCriteria?.$case === "taskDefName") {
      obj.taskDefName = message.wfSpecCriteria.value;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<SearchWfSpecRequest>): SearchWfSpecRequest {
    ...
    if (
      ...
      object.wfSpecCriteria?.value !== undefined &&
      object.wfSpecCriteria?.value !== null
    ) {
      message.wfSpecCriteria = { $case: "name", value: object.wfSpecCriteria.value };
    }
    if (
      ...
      message.wfSpecCriteria = { $case: "prefix", value: object.wfSpecCriteria.value };
    }
    if (
      ...
      message.wfSpecCriteria = { $case: "taskDefName", value: object.wfSpecCriteria.value };
    }
    return message;
  },
};
...
export const SearchWorkflowEventDefRequest = {
  ...
  fromJSON(object: any): SearchWorkflowEventDefRequest {
    return {
      bookmark: isSet(object.bookmark) ? Buffer.from(bytesFromBase64(object.bookmark)) : undefined,
      limit: isSet(object.limit) ? globalThis.Number(object.limit) : undefined,
      prefix: isSet(object.prefix) ? globalThis.String(object.prefix) : undefined,
  ...
  toJSON(message: SearchWorkflowEventDefRequest): unknown {
    const obj: any = {};
    if (message.bookmark !== undefined) {
      obj.bookmark = base64FromBytes(message.bookmark);
    }
...
export const WorkflowEventDefIdList = {
  ...
  fromJSON(object: any): WorkflowEventDefIdList {
    return {
      results: globalThis.Array.isArray(object?.results)
        ? object.results.map((e: any) => WorkflowEventDefId.fromJSON(e))
        : [],
      bookmark: isSet(object.bookmark) ? Buffer.from(bytesFromBase64(object.bookmark)) : undefined,
    };
  },

  toJSON(message: WorkflowEventDefIdList): unknown {
    const obj: any = {};
    if (message.results?.length) {
      obj.results = message.results.map((e) => WorkflowEventDefId.toJSON(e));
    }
    if (message.bookmark !== undefined) {
      obj.bookmark = base64FromBytes(message.bookmark);
    }
...
export const SearchPrincipalRequest = {
  encode(message: SearchPrincipalRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    switch (message.principalCriteria?.$case) {
      case "isAdmin":
        writer.uint32(40).bool(message.principalCriteria.value);
        break;
      case "tenantId":
        writer.uint32(50).string(message.principalCriteria.value);
        break;
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.principalCriteria = { $case: "isAdmin", value: reader.bool() };
          continue;
        case 6:
          if (tag !== 50) {
            break;
          ...
          message.principalCriteria = { $case: "tenantId", value: reader.string() };
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): SearchPrincipalRequest {
    return {
      bookmark: isSet(object.bookmark) ? Buffer.from(bytesFromBase64(object.bookmark)) : undefined,
      limit: isSet(object.limit) ? globalThis.Number(object.limit) : undefined,
      earliestStart: isSet(object.earliestStart) ? globalThis.String(object.earliestStart) : undefined,
      latestStart: isSet(object.latestStart) ? globalThis.String(object.latestStart) : undefined,
      principalCriteria: isSet(object.isAdmin)
        ? { $case: "isAdmin", value: globalThis.Boolean(object.isAdmin) }
        : isSet(object.tenantId)
        ? { $case: "tenantId", value: globalThis.String(object.tenantId) }
        : undefined,
    };
  },

  toJSON(message: SearchPrincipalRequest): unknown {
    const obj: any = {};
    if (message.bookmark !== undefined) {
      obj.bookmark = base64FromBytes(message.bookmark);
    }
    ...
    if (message.principalCriteria?.$case === "isAdmin") {
      obj.isAdmin = message.principalCriteria.value;
    }
    if (message.principalCriteria?.$case === "tenantId") {
      obj.tenantId = message.principalCriteria.value;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<SearchPrincipalRequest>): SearchPrincipalRequest {
    ...
    if (
      ...
      object.principalCriteria?.value !== undefined &&
      object.principalCriteria?.value !== null
    ) {
      message.principalCriteria = { $case: "isAdmin", value: object.principalCriteria.value };
    }
    if (
      ...
      message.principalCriteria = { $case: "tenantId", value: object.principalCriteria.value };
    }
    return message;
  },
};
...
export const PrincipalIdList = {
  ...
  fromJSON(object: any): PrincipalIdList {
    return {
      results: globalThis.Array.isArray(object?.results) ? object.results.map((e: any) => PrincipalId.fromJSON(e)) : [],
      bookmark: isSet(object.bookmark) ? Buffer.from(bytesFromBase64(object.bookmark)) : undefined,
    };
  },

  toJSON(message: PrincipalIdList): unknown {
    const obj: any = {};
    if (message.results?.length) {
      obj.results = message.results.map((e) => PrincipalId.toJSON(e));
    }
    if (message.bookmark !== undefined) {
      obj.bookmark = base64FromBytes(message.bookmark);
    }
...
export const SearchWorkflowEventRequest = {
  ...
  fromJSON(object: any): SearchWorkflowEventRequest {
    return {
      bookmark: isSet(object.bookmark) ? Buffer.from(bytesFromBase64(object.bookmark)) : undefined,
      limit: isSet(object.limit) ? globalThis.Number(object.limit) : undefined,
      earliestStart: isSet(object.earliestStart) ? globalThis.String(object.earliestStart) : undefined,
  ...
  toJSON(message: SearchWorkflowEventRequest): unknown {
    const obj: any = {};
    if (message.bookmark !== undefined) {
      obj.bookmark = base64FromBytes(message.bookmark);
    }
...
export const WorkflowEventIdList = {
  ...
  fromJSON(object: any): WorkflowEventIdList {
    return {
      results: globalThis.Array.isArray(object?.results)
        ? object.results.map((e: any) => WorkflowEventId.fromJSON(e))
        : [],
      bookmark: isSet(object.bookmark) ? Buffer.from(bytesFromBase64(object.bookmark)) : undefined,
    };
  },

  toJSON(message: WorkflowEventIdList): unknown {
    const obj: any = {};
    if (message.results?.length) {
      obj.results = message.results.map((e) => WorkflowEventId.toJSON(e));
    }
    if (message.bookmark !== undefined) {
      obj.bookmark = base64FromBytes(message.bookmark);
    }
...
export const WorkflowEventList = {
  ...
  fromJSON(object: any): WorkflowEventList {
    return {
      results: globalThis.Array.isArray(object?.results)
  ...
  toJSON(message: WorkflowEventList): unknown {
    const obj: any = {};
    if (message.results?.length) {
...
function createBasePutMigrationPlanRequest(): PutMigrationPlanRequest {
  return { name: "", migrationPlan: {}, newWfSpec: undefined };
}
...
export const PutMigrationPlanRequest = {
  encode(message: PutMigrationPlanRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.migrationPlan).forEach(([key, value]) => {
      PutMigrationPlanRequest_MigrationPlanEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).ldelim();
    });
    if (message.newWfSpec !== undefined) {
      WfSpecId.encode(message.newWfSpec, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          const entry2 = PutMigrationPlanRequest_MigrationPlanEntry.decode(reader, reader.uint32());
          if (entry2.value !== undefined) {
            message.migrationPlan[entry2.key] = entry2.value;
          }
          continue;
        case 3:
          if (tag !== 26) {
  ...
  fromJSON(object: any): PutMigrationPlanRequest {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      migrationPlan: isObject(object.migrationPlan)
        ? Object.entries(object.migrationPlan).reduce<{ [key: string]: ThreadMigrationPlan }>((acc, [key, value]) => {
  ...
  toJSON(message: PutMigrationPlanRequest): unknown {
    ...
    if (message.migrationPlan) {
      const entries = Object.entries(message.migrationPlan);
      if (entries.length > 0) {
        obj.migrationPlan = {};
        entries.forEach(([k, v]) => {
          obj.migrationPlan[k] = ThreadMigrationPlan.toJSON(v);
        });
      }
    }
    if (message.newWfSpec !== undefined) {
  ...
  fromPartial(object: DeepPartial<PutMigrationPlanRequest>): PutMigrationPlanRequest {
    const message = createBasePutMigrationPlanRequest();
    message.name = object.name ?? "";
    message.migrationPlan = Object.entries(object.migrationPlan ?? {}).reduce<{ [key: string]: ThreadMigrationPlan }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
...
function createBasePutMigrationPlanRequest_MigrationPlanEntry(): PutMigrationPlanRequest_MigrationPlanEntry {
  return { key: "", value: undefined };
}

export const PutMigrationPlanRequest_MigrationPlanEntry = {
  encode(message: PutMigrationPlanRequest_MigrationPlanEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PutMigrationPlanRequest_MigrationPlanEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePutMigrationPlanRequest_MigrationPlanEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): PutMigrationPlanRequest_MigrationPlanEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
  ...
  toJSON(message: PutMigrationPlanRequest_MigrationPlanEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(base?: DeepPartial<PutMigrationPlanRequest_MigrationPlanEntry>): PutMigrationPlanRequest_MigrationPlanEntry {
    return PutMigrationPlanRequest_MigrationPlanEntry.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<PutMigrationPlanRequest_MigrationPlanEntry>,
  ): PutMigrationPlanRequest_MigrationPlanEntry {
    const message = createBasePutMigrationPlanRequest_MigrationPlanEntry();
    message.key = object.key ?? "";
    message.value = (object.value !== undefined && object.value !== null)
...
function createBaseMigrateWfRunRequest(): MigrateWfRunRequest {
  return { migrationPlanId: undefined, wfRunId: undefined, migrationVars: {} };
}
...
export const MigrationVariables = {
  ...
  fromJSON(object: any): MigrationVariables {
    return {
      varValues: isObject(object.varValues)
        ? Object.entries(object.varValues).reduce<{ [key: string]: VariableAssignment }>((acc, [key, value]) => {
  ...
  toJSON(message: MigrationVariables): unknown {
    ...
    if (message.varValues) {
      ...
      if (entries.length > 0) {
        obj.varValues = {};
        entries.forEach(([k, v]) => {
          obj.varValues[k] = VariableAssignment.toJSON(v);
        });
      }
    }
    return obj;
  ...
  fromPartial(object: DeepPartial<MigrationVariables>): MigrationVariables {
    const message = createBaseMigrationVariables();
    message.varValues = Object.entries(object.varValues ?? {}).reduce<{ [key: string]: VariableAssignment }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
...
export const ReportTaskRun = {
  encode(message: ReportTaskRun, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    switch (message.result?.$case) {
      case "output":
        VariableValue.encode(message.result.value, writer.uint32(34).fork()).ldelim();
        break;
      case "error":
        LHTaskError.encode(message.result.value, writer.uint32(58).fork()).ldelim();
        break;
      case "exception":
...
export const RescueThreadRunRequest = {
  ...
  fromJSON(object: any): RescueThreadRunRequest {
    return {
      wfRunId: isSet(object.wfRunId) ? WfRunId.fromJSON(object.wfRunId) : undefined,
      threadRunNumber: isSet(object.threadRunNumber) ? globalThis.Number(object.threadRunNumber) : 0,
      skipCurrentNode: isSet(object.skipCurrentNode) ? globalThis.Boolean(object.skipCurrentNode) : false,
    };
  },

  toJSON(message: RescueThreadRunRequest): unknown {
    const obj: any = {};
    if (message.wfRunId !== undefined) {
      obj.wfRunId = WfRunId.toJSON(message.wfRunId);
    }
    ...
    if (message.skipCurrentNode !== false) {
      obj.skipCurrentNode = message.skipCurrentNode;
    }
    return obj;
  },
...
export const ScheduledWfRunIdList = {
  ...
  fromJSON(object: any): ScheduledWfRunIdList {
    return {
      results: globalThis.Array.isArray(object?.results)
        ? object.results.map((e: any) => ScheduledWfRunId.fromJSON(e))
        : [],
    };
  },

  toJSON(message: ScheduledWfRunIdList): unknown {
    const obj: any = {};
    if (message.results?.length) {
      obj.results = message.results.map((e) => ScheduledWfRunId.toJSON(e));
    }
    return obj;
  },
...
export const SearchScheduledWfRunRequest = {
  ...
  fromJSON(object: any): SearchScheduledWfRunRequest {
    return {
      wfSpecName: isSet(object.wfSpecName) ? globalThis.String(object.wfSpecName) : "",
      majorVersion: isSet(object.majorVersion) ? globalThis.Number(object.majorVersion) : undefined,
      revision: isSet(object.revision) ? globalThis.Number(object.revision) : undefined,
  ...
  toJSON(message: SearchScheduledWfRunRequest): unknown {
    const obj: any = {};
    if (message.wfSpecName !== "") {
      obj.wfSpecName = message.wfSpecName;
    }
...
export const LittleHorseVersion = {
  encode(message: LittleHorseVersion, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LittleHorseVersion {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): LittleHorseVersion {
    return {
  ...
  toJSON(message: LittleHorseVersion): unknown {
    const obj: any = {};
    if (message.majorVersion !== 0) {
      obj.majorVersion = Math.round(message.majorVersion);
    }
  ...
  create(base?: DeepPartial<LittleHorseVersion>): LittleHorseVersion {
    return LittleHorseVersion.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<LittleHorseVersion>): LittleHorseVersion {
    const message = createBaseLittleHorseVersion();
