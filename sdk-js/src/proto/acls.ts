...
export interface ServerACL {
  ...
  resourceFilter?: { $case: "name"; value: string } | { $case: "prefix"; value: string } | undefined;
}
...
export const ServerACL = {
  encode(message: ServerACL, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    switch (message.resourceFilter?.$case) {
      case "name":
        writer.uint32(26).string(message.resourceFilter.value);
        break;
      case "prefix":
        writer.uint32(34).string(message.resourceFilter.value);
        break;
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.resourceFilter = { $case: "name", value: reader.string() };
          continue;
        case 4:
          if (tag !== 34) {
            break;
          ...
          message.resourceFilter = { $case: "prefix", value: reader.string() };
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ServerACL {
    return {
      ...
      allowedActions: globalThis.Array.isArray(object?.allowedActions)
        ...
        : [],
      resourceFilter: isSet(object.name)
  ...
  toJSON(message: ServerACL): unknown {
    ...
    if (message.resourceFilter?.$case === "name") {
      obj.name = message.resourceFilter.value;
    }
    if (message.resourceFilter?.$case === "prefix") {
      obj.prefix = message.resourceFilter.value;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ServerACL>): ServerACL {
    ...
    if (
      ...
      object.resourceFilter?.value !== undefined &&
      object.resourceFilter?.value !== null
    ) {
      message.resourceFilter = { $case: "name", value: object.resourceFilter.value };
    }
    if (
      ...
      message.resourceFilter = { $case: "prefix", value: object.resourceFilter.value };
    }
    return message;
  },
};
...
export const DeletePrincipalRequest = {
  ...
  fromJSON(object: any): DeletePrincipalRequest {
    return { id: isSet(object.id) ? PrincipalId.fromJSON(object.id) : undefined };
  },
...
export const OutputTopicConfig = {
  ...
  fromJSON(object: any): OutputTopicConfig {
    return {
      defaultRecordingLevel: isSet(object.defaultRecordingLevel)
        ? outputTopicConfig_OutputTopicRecordingLevelFromJSON(object.defaultRecordingLevel)
        : OutputTopicConfig_OutputTopicRecordingLevel.ALL_ENTITY_EVENTS,
    };
  },

  toJSON(message: OutputTopicConfig): unknown {
    const obj: any = {};
    if (message.defaultRecordingLevel !== OutputTopicConfig_OutputTopicRecordingLevel.ALL_ENTITY_EVENTS) {
      obj.defaultRecordingLevel = outputTopicConfig_OutputTopicRecordingLevelToJSON(message.defaultRecordingLevel);
    }
    return obj;
  },
