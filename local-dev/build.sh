...
LH_DASHBOARD_WORK_DIR=$(cd "$SCRIPT_DIR/../docker/dashboard" && pwd)
...
EOF
    ...
    docker build --file ${LH_DASHBOARD_WORK_DIR}/Dockerfile \
        --tag littlehorse/lh-dashboard:latest ${CONTEXT_DIR}
fi
