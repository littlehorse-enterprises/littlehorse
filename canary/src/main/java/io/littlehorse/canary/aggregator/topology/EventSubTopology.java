...
//    private final KStream<MetricKey, MetricValue> stream;
    ...
    public EventSubTopology(
            final KStream<EventKey, EventValue> mainStream, final Duration storeRetention, final String beatsTopic) {
...
//        taskRunBeats
//                .map(EventSubTopology::toLatencyMetricBeat)
//                .to(beatsTopic, Produced.with(ProtobufSerdes.BeatKey(), ProtobufSerdes.BeatValue()));
//
...
//                .peek(EventSubTopology::peekAggregate)
