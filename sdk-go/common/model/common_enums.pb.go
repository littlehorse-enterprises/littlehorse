...
type WaitForThreadsFailureStrategy int32

const (
	WaitForThreadsFailureStrategy_ALL_NODES   WaitForThreadsFailureStrategy = 0
	WaitForThreadsFailureStrategy_SINGLE_NODE WaitForThreadsFailureStrategy = 1
)

// Enum value maps for WaitForThreadsFailureStrategy.
var (
	WaitForThreadsFailureStrategy_name = map[int32]string{
		0: "ALL_NODES",
		1: "SINGLE_NODE",
	}
	WaitForThreadsFailureStrategy_value = map[string]int32{
		"ALL_NODES":   0,
		"SINGLE_NODE": 1,
	}
)

func (x WaitForThreadsFailureStrategy) Enum() *WaitForThreadsFailureStrategy {
	p := new(WaitForThreadsFailureStrategy)
	*p = x
	return p
}

func (x WaitForThreadsFailureStrategy) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (WaitForThreadsFailureStrategy) Descriptor() protoreflect.EnumDescriptor {
	return file_common_enums_proto_enumTypes[4].Descriptor()
}

func (WaitForThreadsFailureStrategy) Type() protoreflect.EnumType {
	return &file_common_enums_proto_enumTypes[4]
}

func (x WaitForThreadsFailureStrategy) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use WaitForThreadsFailureStrategy.Descriptor instead.
func (WaitForThreadsFailureStrategy) EnumDescriptor() ([]byte, []int) {
...
var file_common_enums_proto_rawDesc = []byte{
	...
	0x58, 0x43, 0x45, 0x50, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x06, 0x2a, 0xbc, 0x01, 0x0a, 0x0a, 0x54,
	...
	0x4e, 0x43, 0x45, 0x4c, 0x4c, 0x45, 0x44, 0x10, 0x07, 0x2a, 0x3d, 0x0a, 0x13, 0x4d, 0x65, 0x74,
	...
	0x44, 0x41, 0x59, 0x53, 0x5f, 0x31, 0x10, 0x02, 0x2a, 0x67, 0x0a, 0x0c, 0x56, 0x61, 0x72, 0x69,
	...
	0x07, 0x2a, 0x3f, 0x0a, 0x1d, 0x57, 0x61, 0x69, 0x74, 0x46, 0x6f, 0x72, 0x54, 0x68, 0x72, 0x65,
	0x61, 0x64, 0x73, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65,
	0x67, 0x79, 0x12, 0x0d, 0x0a, 0x09, 0x41, 0x4c, 0x4c, 0x5f, 0x4e, 0x4f, 0x44, 0x45, 0x53, 0x10,
	0x00, 0x12, 0x0f, 0x0a, 0x0b, 0x53, 0x49, 0x4e, 0x47, 0x4c, 0x45, 0x5f, 0x4e, 0x4f, 0x44, 0x45,
	0x10, 0x01, 0x42, 0x2c, 0x0a, 0x1f, 0x69, 0x6f, 0x2e, 0x6c, 0x69, 0x74, 0x74, 0x6c, 0x65, 0x68,
...
var file_common_enums_proto_goTypes = []interface{}{
	...
	(WaitForThreadsFailureStrategy)(0), // 4: littlehorse.WaitForThreadsFailureStrategy
}
