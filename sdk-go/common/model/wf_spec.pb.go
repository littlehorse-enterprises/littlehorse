...
type Node struct {
	...
	GcPolicy          *NodeGcPolicy        `protobuf:"bytes,16,opt,name=gc_policy,json=gcPolicy,proto3,oneof" json:"gc_policy,omitempty"`
...
func (x *Node) GetGcPolicy() *NodeGcPolicy {
	if x != nil {
		return x.GcPolicy
	}
	return nil
...
type NodeGcPolicy struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to NodeGcPolicy:
	//	*NodeGcPolicy_DelayMs
	NodeGcPolicy isNodeGcPolicy_NodeGcPolicy `protobuf_oneof:"node_gc_policy"`
}

func (x *NodeGcPolicy) Reset() {
	*x = NodeGcPolicy{}
	if protoimpl.UnsafeEnabled {
...
func (x *NodeGcPolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NodeGcPolicy) ProtoMessage() {}

func (x *NodeGcPolicy) ProtoReflect() protoreflect.Message {
	mi := &file_wf_spec_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NodeGcPolicy.ProtoReflect.Descriptor instead.
func (*NodeGcPolicy) Descriptor() ([]byte, []int) {
	return file_wf_spec_proto_rawDescGZIP(), []int{14}
}

func (m *NodeGcPolicy) GetNodeGcPolicy() isNodeGcPolicy_NodeGcPolicy {
	if m != nil {
		return m.NodeGcPolicy
	}
	return nil
}

func (x *NodeGcPolicy) GetDelayMs() int64 {
	if x, ok := x.GetNodeGcPolicy().(*NodeGcPolicy_DelayMs); ok {
		return x.DelayMs
	}
	return 0
}

type isNodeGcPolicy_NodeGcPolicy interface {
	isNodeGcPolicy_NodeGcPolicy()
}

type NodeGcPolicy_DelayMs struct {
	// Deletes the NodeRun X ms after the ThreadRun advances from it.
	DelayMs int64 `protobuf:"varint,1,opt,name=delay_ms,json=delayMs,proto3,oneof"`
}

func (*NodeGcPolicy_DelayMs) isNodeGcPolicy_NodeGcPolicy() {}
...
var file_wf_spec_proto_rawDesc = []byte{
	...
	0x0a, 0x0a, 0x08, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x91, 0x07, 0x0a, 0x04,
	...
	0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x73, 0x12, 0x3b, 0x0a, 0x09, 0x67, 0x63, 0x5f, 0x70, 0x6f,
	0x6c, 0x69, 0x63, 0x79, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6c, 0x69, 0x74,
	0x74, 0x6c, 0x65, 0x68, 0x6f, 0x72, 0x73, 0x65, 0x2e, 0x4e, 0x6f, 0x64, 0x65, 0x47, 0x63, 0x50,
	0x6f, 0x6c, 0x69, 0x63, 0x79, 0x48, 0x01, 0x52, 0x08, 0x67, 0x63, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	0x79, 0x88, 0x01, 0x01, 0x12, 0x3d, 0x0a, 0x0a, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x70, 0x6f, 0x69,
	...
	0x65, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x67, 0x63, 0x5f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x22,
	0x3d, 0x0a, 0x0c, 0x4e, 0x6f, 0x64, 0x65, 0x47, 0x63, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12,
	0x1b, 0x0a, 0x08, 0x64, 0x65, 0x6c, 0x61, 0x79, 0x5f, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x48, 0x00, 0x52, 0x07, 0x64, 0x65, 0x6c, 0x61, 0x79, 0x4d, 0x73, 0x42, 0x10, 0x0a, 0x0e,
	0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x67, 0x63, 0x5f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x22, 0xaa,
	...
	0x65, 0x70, 0x5f, 0x6c, 0x65, 0x6e, 0x67, 0x74, 0x68, 0x42, 0x47, 0x0a, 0x1f, 0x69, 0x6f, 0x2e,
...
var file_wf_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_wf_spec_proto_goTypes = []interface{}{
	...
	(*NodeGcPolicy)(nil),                 // 15: littlehorse.NodeGcPolicy
	(*UserTaskNode)(nil),                 // 16: littlehorse.UserTaskNode
	(*EdgeCondition)(nil),                // 17: littlehorse.EdgeCondition
	(*Edge)(nil),                         // 18: littlehorse.Edge
	(*NopNode)(nil),                      // 19: littlehorse.NopNode
	(*SleepNode)(nil),                    // 20: littlehorse.SleepNode
	nil,                                  // 21: littlehorse.WfSpec.ThreadSpecsEntry
	nil,                                  // 22: littlehorse.ThreadSpec.NodesEntry
	nil,                                  // 23: littlehorse.StartThreadNode.VariablesEntry
	nil,                                  // 24: littlehorse.StartMultipleThreadsNode.VariablesEntry
	(*WaitForThreadsNode_ThreadToWaitFor)(nil), // 25: littlehorse.WaitForThreadsNode.ThreadToWaitFor
	(*timestamppb.Timestamp)(nil),              // 26: google.protobuf.Timestamp
	(LHStatus)(0),                              // 27: littlehorse.LHStatus
	(*VariableDef)(nil),                        // 28: littlehorse.VariableDef
	(*VariableAssignment)(nil),                 // 29: littlehorse.VariableAssignment
	(WaitForThreadsPolicy)(0),                  // 30: littlehorse.WaitForThreadsPolicy
	(*VariableMutation)(nil),                   // 31: littlehorse.VariableMutation
	(*TaskNode)(nil),                           // 32: littlehorse.TaskNode
	(*UTActionTrigger)(nil),                    // 33: littlehorse.UTActionTrigger
	(Comparator)(0),                            // 34: littlehorse.Comparator
}
var file_wf_spec_proto_depIdxs = []int32{
	26, // 0: littlehorse.WfSpec.created_at:type_name -> google.protobuf.Timestamp
	27, // 1: littlehorse.WfSpec.status:type_name -> littlehorse.LHStatus
	21, // 2: littlehorse.WfSpec.thread_specs:type_name -> littlehorse.WfSpec.ThreadSpecsEntry
	2,  // 3: littlehorse.WfSpec.retention_policy:type_name -> littlehorse.WorkflowRetentionPolicy
	22, // 4: littlehorse.ThreadSpec.nodes:type_name -> littlehorse.ThreadSpec.NodesEntry
	28, // 5: littlehorse.ThreadSpec.variable_defs:type_name -> littlehorse.VariableDef
	...
	23, // 8: littlehorse.StartThreadNode.variables:type_name -> littlehorse.StartThreadNode.VariablesEntry
	24, // 9: littlehorse.StartMultipleThreadsNode.variables:type_name -> littlehorse.StartMultipleThreadsNode.VariablesEntry
	29, // 10: littlehorse.StartMultipleThreadsNode.iterable:type_name -> littlehorse.VariableAssignment
	0,  // 11: littlehorse.FailureHandlerDef.any_failure_of_type:type_name -> littlehorse.FailureHandlerDef.LHFailureType
	25, // 12: littlehorse.WaitForThreadsNode.threads:type_name -> littlehorse.WaitForThreadsNode.ThreadToWaitFor
	29, // 13: littlehorse.WaitForThreadsNode.thread_list:type_name -> littlehorse.VariableAssignment
	30, // 14: littlehorse.WaitForThreadsNode.policy:type_name -> littlehorse.WaitForThreadsPolicy
	29, // 15: littlehorse.ExternalEventNode.timeout_seconds:type_name -> littlehorse.VariableAssignment
	13, // 16: littlehorse.ExitNode.failure_def:type_name -> littlehorse.FailureDef
	29, // 17: littlehorse.FailureDef.content:type_name -> littlehorse.VariableAssignment
	18, // 18: littlehorse.Node.outgoing_edges:type_name -> littlehorse.Edge
	31, // 19: littlehorse.Node.variable_mutations:type_name -> littlehorse.VariableMutation
	8,  // 20: littlehorse.Node.failure_handlers:type_name -> littlehorse.FailureHandlerDef
	15, // 21: littlehorse.Node.gc_policy:type_name -> littlehorse.NodeGcPolicy
	...
	32, // 24: littlehorse.Node.task:type_name -> littlehorse.TaskNode
	...
	19, // 28: littlehorse.Node.nop:type_name -> littlehorse.NopNode
	20, // 29: littlehorse.Node.sleep:type_name -> littlehorse.SleepNode
	16, // 30: littlehorse.Node.user_task:type_name -> littlehorse.UserTaskNode
	7,  // 31: littlehorse.Node.start_multiple_threads:type_name -> littlehorse.StartMultipleThreadsNode
	29, // 32: littlehorse.UserTaskNode.user_group:type_name -> littlehorse.VariableAssignment
	29, // 33: littlehorse.UserTaskNode.user_id:type_name -> littlehorse.VariableAssignment
	33, // 34: littlehorse.UserTaskNode.actions:type_name -> littlehorse.UTActionTrigger
	29, // 35: littlehorse.UserTaskNode.notes:type_name -> littlehorse.VariableAssignment
	34, // 36: littlehorse.EdgeCondition.comparator:type_name -> littlehorse.Comparator
	29, // 37: littlehorse.EdgeCondition.left:type_name -> littlehorse.VariableAssignment
	29, // 38: littlehorse.EdgeCondition.right:type_name -> littlehorse.VariableAssignment
	17, // 39: littlehorse.Edge.condition:type_name -> littlehorse.EdgeCondition
	29, // 40: littlehorse.SleepNode.raw_seconds:type_name -> littlehorse.VariableAssignment
	29, // 41: littlehorse.SleepNode.timestamp:type_name -> littlehorse.VariableAssignment
	29, // 42: littlehorse.SleepNode.iso_date:type_name -> littlehorse.VariableAssignment
	3,  // 43: littlehorse.WfSpec.ThreadSpecsEntry.value:type_name -> littlehorse.ThreadSpec
	14, // 44: littlehorse.ThreadSpec.NodesEntry.value:type_name -> littlehorse.Node
	29, // 45: littlehorse.StartThreadNode.VariablesEntry.value:type_name -> littlehorse.VariableAssignment
	29, // 46: littlehorse.StartMultipleThreadsNode.VariablesEntry.value:type_name -> littlehorse.VariableAssignment
	29, // 47: littlehorse.WaitForThreadsNode.ThreadToWaitFor.thread_run_number:type_name -> littlehorse.VariableAssignment
