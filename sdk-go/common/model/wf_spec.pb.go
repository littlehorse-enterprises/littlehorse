...
var file_wf_spec_proto_rawDesc = []byte{
	...
	0x56, 0x41, 0x52, 0x10, 0x02, 0x42, 0x47, 0x0a, 0x1f, 0x69, 0x6f, 0x2e, 0x6c, 0x69, 0x74, 0x74,
...
var file_wf_spec_proto_depIdxs = []int32{
	...
	43, // 48: littlehorse.UserTaskNode.on_cancellation_exception_name:type_name -> littlehorse.VariableAssignment
	47, // 49: littlehorse.EdgeCondition.comparator:type_name -> littlehorse.Comparator
	43, // 50: littlehorse.EdgeCondition.left:type_name -> littlehorse.VariableAssignment
	43, // 51: littlehorse.EdgeCondition.right:type_name -> littlehorse.VariableAssignment
	21, // 52: littlehorse.Edge.condition:type_name -> littlehorse.EdgeCondition
	48, // 53: littlehorse.Edge.variable_mutations:type_name -> littlehorse.VariableMutation
	43, // 54: littlehorse.SleepNode.raw_seconds:type_name -> littlehorse.VariableAssignment
	43, // 55: littlehorse.SleepNode.timestamp:type_name -> littlehorse.VariableAssignment
	43, // 56: littlehorse.SleepNode.iso_date:type_name -> littlehorse.VariableAssignment
	35, // 57: littlehorse.WfSpecVersionMigration.thread_spec_migrations:type_name -> littlehorse.WfSpecVersionMigration.ThreadSpecMigrationsEntry
	36, // 58: littlehorse.ThreadSpecMigration.node_migrations:type_name -> littlehorse.ThreadSpecMigration.NodeMigrationsEntry
	7,  // 59: littlehorse.WfSpec.ThreadSpecsEntry.value:type_name -> littlehorse.ThreadSpec
	18, // 60: littlehorse.ThreadSpec.NodesEntry.value:type_name -> littlehorse.Node
	43, // 61: littlehorse.StartThreadNode.VariablesEntry.value:type_name -> littlehorse.VariableAssignment
	43, // 62: littlehorse.StartMultipleThreadsNode.VariablesEntry.value:type_name -> littlehorse.VariableAssignment
	43, // 63: littlehorse.WaitForThreadsNode.ThreadToWaitFor.thread_run_number:type_name -> littlehorse.VariableAssignment
	33, // 64: littlehorse.WaitForThreadsNode.ThreadsToWaitFor.threads:type_name -> littlehorse.WaitForThreadsNode.ThreadToWaitFor
	26, // 65: littlehorse.WfSpecVersionMigration.ThreadSpecMigrationsEntry.value:type_name -> littlehorse.ThreadSpecMigration
	27, // 66: littlehorse.ThreadSpecMigration.NodeMigrationsEntry.value:type_name -> littlehorse.NodeMigration
