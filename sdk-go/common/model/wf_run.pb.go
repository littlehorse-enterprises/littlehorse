...
type FailingHaltReason struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *FailingHaltReason) Reset() {
	*x = FailingHaltReason{}
	if protoimpl.UnsafeEnabled {
...
func (x *FailingHaltReason) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FailingHaltReason) ProtoMessage() {}

func (x *FailingHaltReason) ProtoReflect() protoreflect.Message {
	mi := &file_wf_run_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FailingHaltReason.ProtoReflect.Descriptor instead.
func (*FailingHaltReason) Descriptor() ([]byte, []int) {
...
func (x *ThreadHaltReason) GetFailing() *FailingHaltReason {
	if x, ok := x.GetReason().(*ThreadHaltReason_Failing); ok {
		return x.Failing
	}
	return nil
}
...
func (*ThreadHaltReason_Failing) isThreadHaltReason_Reason() {}
...
var file_wf_run_proto_rawDesc = []byte{
	...
	0x6e, 0x69, 0x6e, 0x67, 0x4f, 0x66, 0x4c, 0x69, 0x66, 0x65, 0x22, 0x13, 0x0a, 0x11, 0x46, 0x61,
	0x69, 0x6c, 0x69, 0x6e, 0x67, 0x48, 0x61, 0x6c, 0x74, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22,
	0x9a, 0x04, 0x0a, 0x10, 0x54, 0x68, 0x72, 0x65, 0x61, 0x64, 0x48, 0x61, 0x6c, 0x74, 0x52, 0x65,
	...
	0x61, 0x6c, 0x48, 0x61, 0x6c, 0x74, 0x12, 0x3a, 0x0a, 0x07, 0x66, 0x61, 0x69, 0x6c, 0x69, 0x6e,
	0x67, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6c, 0x69, 0x74, 0x74, 0x6c, 0x65,
	0x68, 0x6f, 0x72, 0x73, 0x65, 0x2e, 0x46, 0x61, 0x69, 0x6c, 0x69, 0x6e, 0x67, 0x48, 0x61, 0x6c,
	0x74, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x07, 0x66, 0x61, 0x69, 0x6c, 0x69,
	0x6e, 0x67, 0x42, 0x08, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x2a, 0x4b, 0x0a, 0x0a,
	0x54, 0x68, 0x72, 0x65, 0x61, 0x64, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0e, 0x0a, 0x0a, 0x45, 0x4e,
	...
	0x48, 0x41, 0x4e, 0x44, 0x4c, 0x45, 0x52, 0x10, 0x03, 0x42, 0x47, 0x0a, 0x1f, 0x69, 0x6f, 0x2e,
...
var file_wf_run_proto_goTypes = []interface{}{
	...
	(*FailingHaltReason)(nil),               // 12: littlehorse.FailingHaltReason
...
var file_wf_run_proto_depIdxs = []int32{
	...
	18, // 17: littlehorse.PendingInterrupt.external_event_id:type_name -> littlehorse.ExternalEventId
	18, // 18: littlehorse.PendingInterruptHaltReason.external_event_id:type_name -> littlehorse.ExternalEventId
	...
	12, // 25: littlehorse.ThreadHaltReason.failing:type_name -> littlehorse.FailingHaltReason
...
func file_wf_run_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_wf_run_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FailingHaltReason); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
