...
func (x *ExponentialBackoffRetryPolicy) GetMaxRetries() int32 {
	if x != nil {
		return x.MaxRetries
	}
	return 0
...
type TaskNode struct {
	...
	// The policy for scheduling additional TaskAttempt's upon encountering a retryable error.
	...
	//	*TaskNode_SimpleRetries
	//	*TaskNode_ExponentialBackoff
	RetryPolicy isTaskNode_RetryPolicy `protobuf_oneof:"retry_policy"`
...
func (m *TaskNode) GetRetryPolicy() isTaskNode_RetryPolicy {
	if m != nil {
...
func (x *TaskNode) GetSimpleRetries() int32 {
	if x, ok := x.GetRetryPolicy().(*TaskNode_SimpleRetries); ok {
		return x.SimpleRetries
	}
	return 0
}

func (x *TaskNode) GetExponentialBackoff() *ExponentialBackoffRetryPolicy {
	if x, ok := x.GetRetryPolicy().(*TaskNode_ExponentialBackoff); ok {
...
type isTaskNode_RetryPolicy interface {
	isTaskNode_RetryPolicy()
}

type TaskNode_SimpleRetries struct {
	// Simplest retry policy. Retries are immediately put back on the Task Queue, up to
	// the configured number of retries.
	SimpleRetries int32 `protobuf:"varint,3,opt,name=simple_retries,json=simpleRetries,proto3,oneof"`
}

type TaskNode_ExponentialBackoff struct {
	// Retry with Exponential Backoff.
	ExponentialBackoff *ExponentialBackoffRetryPolicy `protobuf:"bytes,5,opt,name=exponential_backoff,json=exponentialBackoff,proto3,oneof"`
}

func (*TaskNode_SimpleRetries) isTaskNode_RetryPolicy() {}

func (*TaskNode_ExponentialBackoff) isTaskNode_RetryPolicy() {}
...
var file_common_wfspec_proto_rawDesc = []byte{
	...
	0xac, 0x01, 0x0a, 0x1d, 0x45, 0x78, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x42,
	...
	0x03, 0x52, 0x0a, 0x6d, 0x61, 0x78, 0x44, 0x65, 0x6c, 0x61, 0x79, 0x4d, 0x73, 0x12, 0x1f, 0x0a,
	0x0b, 0x6d, 0x61, 0x78, 0x5f, 0x72, 0x65, 0x74, 0x72, 0x69, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x0a, 0x6d, 0x61, 0x78, 0x52, 0x65, 0x74, 0x72, 0x69, 0x65, 0x73, 0x12, 0x1e,
	0x0a, 0x0a, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x02, 0x52, 0x0a, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x22, 0xc2,
	0x02, 0x0a, 0x08, 0x54, 0x61, 0x73, 0x6b, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x36, 0x0a, 0x0b, 0x74,
	...
	0x66, 0x49, 0x64, 0x12, 0x27, 0x0a, 0x0f, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x5f, 0x73,
	0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x74, 0x69,
	0x6d, 0x65, 0x6f, 0x75, 0x74, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x27, 0x0a, 0x0e,
	0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x5f, 0x72, 0x65, 0x74, 0x72, 0x69, 0x65, 0x73, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x05, 0x48, 0x00, 0x52, 0x0d, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65,
	0x74, 0x72, 0x69, 0x65, 0x73, 0x12, 0x5d, 0x0a, 0x13, 0x65, 0x78, 0x70, 0x6f, 0x6e, 0x65, 0x6e,
	...
	0x6b, 0x6f, 0x66, 0x66, 0x12, 0x3d, 0x0a, 0x09, 0x76, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65,
	...
	0x6c, 0x65, 0x73, 0x42, 0x0e, 0x0a, 0x0c, 0x72, 0x65, 0x74, 0x72, 0x79, 0x5f, 0x70, 0x6f, 0x6c,
	0x69, 0x63, 0x79, 0x2a, 0x98, 0x01, 0x0a, 0x14, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65,
	...
	0x5f, 0x49, 0x4e, 0x10, 0x07, 0x42, 0x47, 0x0a, 0x1f, 0x69, 0x6f, 0x2e, 0x6c, 0x69, 0x74, 0x74,
...
var file_common_wfspec_proto_depIdxs = []int32{
	...
	7,  // 14: littlehorse.TaskNode.exponential_backoff:type_name -> littlehorse.ExponentialBackoffRetryPolicy
	3,  // 15: littlehorse.TaskNode.variables:type_name -> littlehorse.VariableAssignment
	3,  // 16: littlehorse.VariableAssignment.FormatString.format:type_name -> littlehorse.VariableAssignment
	3,  // 17: littlehorse.VariableAssignment.FormatString.args:type_name -> littlehorse.VariableAssignment
	8,  // 18: littlehorse.UTActionTrigger.UTATask.task:type_name -> littlehorse.TaskNode
	4,  // 19: littlehorse.UTActionTrigger.UTATask.mutations:type_name -> littlehorse.VariableMutation
	3,  // 20: littlehorse.UTActionTrigger.UTAReassign.user_id:type_name -> littlehorse.VariableAssignment
	3,  // 21: littlehorse.UTActionTrigger.UTAReassign.user_group:type_name -> littlehorse.VariableAssignment
...
func file_common_wfspec_proto_init() {
	...
	file_common_wfspec_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*TaskNode_SimpleRetries)(nil),
		(*TaskNode_ExponentialBackoff)(nil),
	}
