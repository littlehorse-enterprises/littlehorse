...
func (x *TaskWorkerGroup) GetTaskDefId() *TaskDefId {
	if x != nil {
		return x.TaskDefId
	}
	return nil
...
var file_service_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x05, 0x68, 0x6f, 0x73, 0x74, 0x73, 0x22, 0xb7, 0x02,
	0x0a, 0x0f, 0x54, 0x61, 0x73, 0x6b, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x47, 0x72, 0x6f, 0x75,
	0x70, 0x12, 0x36, 0x0a, 0x0b, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x64, 0x65, 0x66, 0x5f, 0x69, 0x64,
	...
	0x74, 0x61, 0x73, 0x6b, 0x44, 0x65, 0x66, 0x49, 0x64, 0x12, 0x39, 0x0a, 0x0a, 0x63, 0x72, 0x65,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xb3, 0x01, 0x0a, 0x0f, 0x50, 0x6f, 0x6c, 0x6c,
	...
	0x2a, 0x57, 0x0a, 0x0e, 0x4c, 0x48, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x12, 0x15, 0x0a, 0x11, 0x4c, 0x48, 0x5f, 0x48, 0x45, 0x41, 0x4c, 0x54, 0x48, 0x5f,
	...
	0x48, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x02, 0x32, 0x92, 0x22, 0x0a, 0x0b, 0x4c, 0x48,
	0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x41, 0x70, 0x69, 0x12, 0x44, 0x0a, 0x0a, 0x50, 0x75, 0x74,
	...
	0x72, 0x73, 0x65, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x44, 0x65, 0x66, 0x22, 0x00, 0x12, 0x5f, 0x0a,
	...
	0x73, 0x65, 0x2e, 0x50, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x61, 0x6c, 0x22, 0x00, 0x42, 0x47,
...
var file_service_proto_depIdxs = []int32{
	...
	82,  // 47: littlehorse.TaskWorkerGroup.task_def_id:type_name -> littlehorse.TaskDefId
	...
	94,  // 53: littlehorse.ScheduledTask.variables:type_name -> littlehorse.VarNameAndVal
	88,  // 54: littlehorse.ScheduledTask.created_at:type_name -> google.protobuf.Timestamp
	95,  // 55: littlehorse.ScheduledTask.source:type_name -> littlehorse.TaskRunSource
	...
	96,  // 59: littlehorse.ReportTaskRun.status:type_name -> littlehorse.TaskStatus
	...
	97,  // 62: littlehorse.ReportTaskRun.error:type_name -> littlehorse.LHTaskError
	98,  // 63: littlehorse.ReportTaskRun.exception:type_name -> littlehorse.LHTaskException
	...
	99,  // 67: littlehorse.TaskDefMetricsQueryRequest.window_type:type_name -> littlehorse.MetricsWindowLength
	...
	99,  // 70: littlehorse.ListTaskMetricsRequest.window_length:type_name -> littlehorse.MetricsWindowLength
	...
	99,  // 74: littlehorse.WfSpecMetricsQueryRequest.window_length:type_name -> littlehorse.MetricsWindowLength
	...
	99,  // 77: littlehorse.ListWfMetricsRequest.window_length:type_name -> littlehorse.MetricsWindowLength
	...
	99,  // 81: littlehorse.TaskDefMetrics.type:type_name -> littlehorse.MetricsWindowLength
	...
	99,  // 84: littlehorse.WfSpecMetrics.type:type_name -> littlehorse.MetricsWindowLength
	78,  // 85: littlehorse.ListUserTaskRunRequest.wf_run_id:type_name -> littlehorse.WfRunId
	100, // 86: littlehorse.UserTaskRunList.results:type_name -> littlehorse.UserTaskRun
	78,  // 87: littlehorse.ListTaskRunsRequest.wf_run_id:type_name -> littlehorse.WfRunId
	101, // 88: littlehorse.TaskRunList.results:type_name -> littlehorse.TaskRun
	84,  // 89: littlehorse.MigrateWfSpecRequest.old_wf_spec:type_name -> littlehorse.WfSpecId
	102, // 90: littlehorse.MigrateWfSpecRequest.migration:type_name -> littlehorse.WfSpecVersionMigration
	103, // 91: littlehorse.PutWfSpecRequest.ThreadSpecsEntry.value:type_name -> littlehorse.ThreadSpec
	80,  // 92: littlehorse.RunWfRequest.VariablesEntry.value:type_name -> littlehorse.VariableValue
	104, // 93: littlehorse.SearchWfRunRequest.StatusAndSpecRequest.status:type_name -> littlehorse.LHStatus
	...
	104, // 98: littlehorse.SearchWfRunRequest.StatusAndNameRequest.status:type_name -> littlehorse.LHStatus
	...
	96,  // 101: littlehorse.SearchTaskRunRequest.StatusAndTaskDefRequest.status:type_name -> littlehorse.TaskStatus
	...
	105, // 114: littlehorse.LHPublicApi.GetLatestWfSpec:input_type -> littlehorse.GetLatestWfSpecRequest
	...
	106, // 122: littlehorse.LHPublicApi.AssignUserTaskRun:input_type -> littlehorse.AssignUserTaskRunRequest
	107, // 123: littlehorse.LHPublicApi.CompleteUserTaskRun:input_type -> littlehorse.CompleteUserTaskRunRequest
	108, // 124: littlehorse.LHPublicApi.CancelUserTaskRun:input_type -> littlehorse.CancelUserTaskRunRequest
	...
	109, // 159: littlehorse.LHPublicApi.PutTenant:input_type -> littlehorse.PutTenantRequest
	110, // 160: littlehorse.LHPublicApi.PutPrincipal:input_type -> littlehorse.PutPrincipalRequest
	111, // 161: littlehorse.LHPublicApi.Whoami:input_type -> google.protobuf.Empty
	112, // 162: littlehorse.LHPublicApi.PutTaskDef:output_type -> littlehorse.TaskDef
	112, // 163: littlehorse.LHPublicApi.GetTaskDef:output_type -> littlehorse.TaskDef
	113, // 164: littlehorse.LHPublicApi.PutExternalEventDef:output_type -> littlehorse.ExternalEventDef
	113, // 165: littlehorse.LHPublicApi.GetExternalEventDef:output_type -> littlehorse.ExternalEventDef
	114, // 166: littlehorse.LHPublicApi.PutWfSpec:output_type -> littlehorse.WfSpec
	114, // 167: littlehorse.LHPublicApi.GetWfSpec:output_type -> littlehorse.WfSpec
	114, // 168: littlehorse.LHPublicApi.GetLatestWfSpec:output_type -> littlehorse.WfSpec
	114, // 169: littlehorse.LHPublicApi.MigrateWfSpec:output_type -> littlehorse.WfSpec
	115, // 170: littlehorse.LHPublicApi.PutUserTaskDef:output_type -> littlehorse.UserTaskDef
	115, // 171: littlehorse.LHPublicApi.GetUserTaskDef:output_type -> littlehorse.UserTaskDef
	115, // 172: littlehorse.LHPublicApi.GetLatestUserTaskDef:output_type -> littlehorse.UserTaskDef
	116, // 173: littlehorse.LHPublicApi.RunWf:output_type -> littlehorse.WfRun
	116, // 174: littlehorse.LHPublicApi.GetWfRun:output_type -> littlehorse.WfRun
	100, // 175: littlehorse.LHPublicApi.GetUserTaskRun:output_type -> littlehorse.UserTaskRun
	111, // 176: littlehorse.LHPublicApi.AssignUserTaskRun:output_type -> google.protobuf.Empty
	111, // 177: littlehorse.LHPublicApi.CompleteUserTaskRun:output_type -> google.protobuf.Empty
	111, // 178: littlehorse.LHPublicApi.CancelUserTaskRun:output_type -> google.protobuf.Empty
	...
	101, // 182: littlehorse.LHPublicApi.GetTaskRun:output_type -> littlehorse.TaskRun
	...
	111, // 201: littlehorse.LHPublicApi.ReportTask:output_type -> google.protobuf.Empty
	111, // 202: littlehorse.LHPublicApi.StopWfRun:output_type -> google.protobuf.Empty
	111, // 203: littlehorse.LHPublicApi.ResumeWfRun:output_type -> google.protobuf.Empty
	111, // 204: littlehorse.LHPublicApi.DeleteWfRun:output_type -> google.protobuf.Empty
	111, // 205: littlehorse.LHPublicApi.DeleteTaskDef:output_type -> google.protobuf.Empty
	111, // 206: littlehorse.LHPublicApi.DeleteWfSpec:output_type -> google.protobuf.Empty
	111, // 207: littlehorse.LHPublicApi.DeleteUserTaskDef:output_type -> google.protobuf.Empty
	111, // 208: littlehorse.LHPublicApi.DeleteExternalEventDef:output_type -> google.protobuf.Empty
	...
	117, // 213: littlehorse.LHPublicApi.PutTenant:output_type -> littlehorse.Tenant
	118, // 214: littlehorse.LHPublicApi.PutPrincipal:output_type -> littlehorse.Principal
	118, // 215: littlehorse.LHPublicApi.Whoami:output_type -> littlehorse.Principal
