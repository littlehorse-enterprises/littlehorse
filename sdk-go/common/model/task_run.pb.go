...
type TaskRun struct {
	...
	// Types that are assignable to RetryPolicy:
	//	*TaskRun_SimpleTotalAttempts
	//	*TaskRun_ExponentialBackoff
	RetryPolicy isTaskRun_RetryPolicy `protobuf_oneof:"retry_policy"`
}
...
func (m *TaskRun) GetRetryPolicy() isTaskRun_RetryPolicy {
	if m != nil {
...
func (x *TaskRun) GetSimpleTotalAttempts() int32 {
	if x, ok := x.GetRetryPolicy().(*TaskRun_SimpleTotalAttempts); ok {
		return x.SimpleTotalAttempts
	}
	return 0
}

func (x *TaskRun) GetExponentialBackoff() *ExponentialBackoffRetryPolicy {
	if x, ok := x.GetRetryPolicy().(*TaskRun_ExponentialBackoff); ok {
		return x.ExponentialBackoff
	}
	return nil
}

type isTaskRun_RetryPolicy interface {
	isTaskRun_RetryPolicy()
}

type TaskRun_SimpleTotalAttempts struct {
	...
	SimpleTotalAttempts int32 `protobuf:"varint,4,opt,name=simple_total_attempts,json=simpleTotalAttempts,proto3,oneof"`
}

type TaskRun_ExponentialBackoff struct {
	// Use an Exponential Backoff Retry Policy.
	ExponentialBackoff *ExponentialBackoffRetryPolicy `protobuf:"bytes,10,opt,name=exponential_backoff,json=exponentialBackoff,proto3,oneof"`
}

func (*TaskRun_SimpleTotalAttempts) isTaskRun_RetryPolicy() {}

func (*TaskRun_ExponentialBackoff) isTaskRun_RetryPolicy() {}
...
var file_task_run_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x6b, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd6, 0x04, 0x0a, 0x07, 0x54,
	...
	0x0a, 0x15, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x61,
	0x74, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x48, 0x00, 0x52,
	0x13, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x41, 0x74, 0x74, 0x65,
	0x6d, 0x70, 0x74, 0x73, 0x12, 0x5d, 0x0a, 0x13, 0x65, 0x78, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74,
	...
	0x66, 0x66, 0x52, 0x65, 0x74, 0x72, 0x79, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x48, 0x00, 0x52,
	0x12, 0x65, 0x78, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x42, 0x61, 0x63, 0x6b,
	0x6f, 0x66, 0x66, 0x42, 0x0e, 0x0a, 0x0c, 0x72, 0x65, 0x74, 0x72, 0x79, 0x5f, 0x70, 0x6f, 0x6c,
	0x69, 0x63, 0x79, 0x22, 0x5c, 0x0a, 0x0d, 0x56, 0x61, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x41, 0x6e,
	...
	0x65, 0x22, 0xa0, 0x05, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x41, 0x74, 0x74, 0x65, 0x6d, 0x70,
	0x74, 0x12, 0x3e, 0x0a, 0x0a, 0x6c, 0x6f, 0x67, 0x5f, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x18,
	...
	0x75, 0x74, 0x70, 0x75, 0x74, 0x12, 0x30, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x0a,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x6c, 0x69, 0x74,
	...
	,
	...
	0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x48, 0x00, 0x52, 0x0f, 0x75, 0x73, 0x65, 0x72, 0x54,
	0x61, 0x73, 0x6b, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x12, 0x38, 0x0a, 0x0a, 0x77, 0x66,
	...
	0x70, 0x65, 0x63, 0x49, 0x64, 0x48, 0x01, 0x52, 0x08, 0x77, 0x66, 0x53, 0x70, 0x65, 0x63, 0x49,
	0x64, 0x88, 0x01, 0x01, 0x42, 0x11, 0x0a, 0x0f, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x72, 0x75, 0x6e,
	0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x77, 0x66, 0x5f, 0x73,
	0x70, 0x65, 0x63, 0x5f, 0x69, 0x64, 0x22, 0x4b, 0x0a, 0x11, 0x54, 0x61, 0x73, 0x6b, 0x4e, 0x6f,
	0x64, 0x65, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x0b, 0x6e,
	...
	,
...
var file_task_run_proto_goTypes = []interface{}{
	...
	(*ExponentialBackoffRetryPolicy)(nil), // 11: littlehorse.ExponentialBackoffRetryPolicy
	(*VariableValue)(nil),                 // 12: littlehorse.VariableValue
	(*UserTaskTriggerReference)(nil),      // 13: littlehorse.UserTaskTriggerReference
	(*WfSpecId)(nil),                      // 14: littlehorse.WfSpecId
	(*NodeRunId)(nil),                     // 15: littlehorse.NodeRunId
	(LHErrorType)(0),                      // 16: littlehorse.LHErrorType
}
var file_task_run_proto_depIdxs = []int32{
	...
	11, // 7: littlehorse.TaskRun.exponential_backoff:type_name -> littlehorse.ExponentialBackoffRetryPolicy
	12, // 8: littlehorse.VarNameAndVal.value:type_name -> littlehorse.VariableValue
	12, // 9: littlehorse.TaskAttempt.log_output:type_name -> littlehorse.VariableValue
	9,  // 10: littlehorse.TaskAttempt.schedule_time:type_name -> google.protobuf.Timestamp
	9,  // 11: littlehorse.TaskAttempt.start_time:type_name -> google.protobuf.Timestamp
	9,  // 12: littlehorse.TaskAttempt.end_time:type_name -> google.protobuf.Timestamp
	10, // 13: littlehorse.TaskAttempt.status:type_name -> littlehorse.TaskStatus
	12, // 14: littlehorse.TaskAttempt.output:type_name -> littlehorse.VariableValue
	...
	13, // 18: littlehorse.TaskRunSource.user_task_trigger:type_name -> littlehorse.UserTaskTriggerReference
	14, // 19: littlehorse.TaskRunSource.wf_spec_id:type_name -> littlehorse.WfSpecId
	15, // 20: littlehorse.TaskNodeReference.node_run_id:type_name -> littlehorse.NodeRunId
	16, // 21: littlehorse.LHTaskError.type:type_name -> littlehorse.LHErrorType
...
func file_task_run_proto_init() {
	...
	file_task_run_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*TaskRun_SimpleTotalAttempts)(nil),
		(*TaskRun_ExponentialBackoff)(nil),
	}
