...
const (
	...
	Operation_DIVIDE Operation = 5
	// Remove any occurrences of RHS from LHS (LHS must be JSON_ARR)
	Operation_REMOVE_IF_PRESENT Operation = 6
	// Remove item at index RHS from LHS (LHS must be JSON_ARR)
	Operation_REMOVE_INDEX Operation = 7
	// Remove the key specified by RHS from the LHS (LHS must be JSON_OBJ)
	Operation_REMOVE_KEY Operation = 8
	// Equivalent to `<`. Only valid for primitive types (no JSON_OBJ or JSON_ARR).
	Operation_LESS_THAN Operation = 9
	// Equivalent to `>`. Only valid for primitive types (no JSON_OBJ or JSON_ARR).
	Operation_GREATER_THAN Operation = 10
	// Equivalent to `<=`. Only valid for primitive types (no JSON_OBJ or JSON_ARR).
	Operation_LESS_THAN_EQ Operation = 11
	// Equivalent to `>=`. Only valid for primitive types (no JSON_OBJ or JSON_ARR).
	Operation_GREATER_THAN_EQ Operation = 12
	...
	Operation_EQUALS Operation = 13
	// This is the inverse of `EQUALS`
	Operation_NOT_EQUALS Operation = 14
	...
	// is equal to the LHS.
	Operation_IN Operation = 15
	// The inverse of IN.
	Operation_NOT_IN Operation = 16
)
...
type VariableMutation struct {
	...
	Operation Operation `protobuf:"varint,3,opt,name=operation,proto3,enum=littlehorse.Operation" json:"operation,omitempty"`
...
func (x *VariableMutation) GetOperation() Operation {
	if x != nil {
		return x.Operation
	}
...
type VariableAssignment_Expression struct {
	...
	Operation Operation `protobuf:"varint,2,opt,name=operation,proto3,enum=littlehorse.Operation" json:"operation,omitempty"`
...
func (x *VariableAssignment_Expression) GetOperation() Operation {
	if x != nil {
		return x.Operation
	}
	return Operation_ASSIGN
...
var file_common_wfspec_proto_rawDesc = []byte{
	...
	0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8a, 0x07, 0x0a, 0x12, 0x56, 0x61, 0x72, 0x69,
	...
	0x6f, 0x64, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0xa8, 0x01, 0x0a, 0x0a, 0x45, 0x78, 0x70, 0x72,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x48, 0x03, 0x52, 0x07, 0x74, 0x79, 0x70, 0x65, 0x44, 0x65, 0x66, 0x88, 0x01, 0x01, 0x42,
	0x07, 0x0a, 0x05, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x42, 0x10, 0x0a, 0x0e, 0x5f, 0x64, 0x65, 0x66,
	0x61, 0x75, 0x6c, 0x74, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x0f, 0x0a, 0x0d, 0x5f, 0x6d,
	0x61, 0x73, 0x6b, 0x65, 0x64, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x0b, 0x0a, 0x09, 0x5f,
	0x74, 0x79, 0x70, 0x65, 0x5f, 0x64, 0x65, 0x66, 0x22, 0xc8, 0x01, 0x0a, 0x0e, 0x54, 0x79, 0x70,
	0x65, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x42, 0x0a, 0x0e, 0x70,
	...
	0x65, 0x2e, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x48, 0x00,
	0x52, 0x0d, 0x70, 0x72, 0x69, 0x6d, 0x69, 0x74, 0x69, 0x76, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12,
	0x3e, 0x0a, 0x0d, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x5f, 0x64, 0x65, 0x66, 0x5f, 0x69, 0x64,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6c, 0x69, 0x74, 0x74, 0x6c, 0x65, 0x68,
	0x6f, 0x72, 0x73, 0x65, 0x2e, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x44, 0x65, 0x66, 0x49, 0x64,
	0x48, 0x00, 0x52, 0x0b, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x44, 0x65, 0x66, 0x49, 0x64, 0x12,
	...
	0x03, 0x10, 0x04, 0x22, 0x5f, 0x0a, 0x0a, 0x52, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x54, 0x79, 0x70,
	0x65, 0x12, 0x41, 0x0a, 0x0b, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65,
	...
	0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x0a, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x54, 0x79, 0x70,
	0x65, 0x88, 0x01, 0x01, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x5f,
	0x74, 0x79, 0x70, 0x65, 0x22, 0xbf, 0x05, 0x0a, 0x0f, 0x55, 0x54, 0x41, 0x63, 0x74, 0x69, 0x6f,
	...
	0x44, 0x65, 0x66, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa4,
	...
	0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x2a, 0x85, 0x02, 0x0a, 0x09,
	0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0a, 0x0a, 0x06, 0x41, 0x53, 0x53,
	...
	,
...
var file_common_wfspec_proto_goTypes = []interface{}{
	(Operation)(0),                                 // 0: littlehorse.Operation
	...
	(*ReturnType)(nil),                             // 6: littlehorse.ReturnType
	(*UTActionTrigger)(nil),                        // 7: littlehorse.UTActionTrigger
	(*ExponentialBackoffRetryPolicy)(nil),          // 8: littlehorse.ExponentialBackoffRetryPolicy
	(*TaskNode)(nil),                               // 9: littlehorse.TaskNode
	(*InlineStructDef)(nil),                        // 10: littlehorse.InlineStructDef
	(*StructFieldDef)(nil),                         // 11: littlehorse.StructFieldDef
	...
	(*TaskDefId)(nil),                              // 25: littlehorse.TaskDefId
}
var file_common_wfspec_proto_depIdxs = []int32{
	...
	5,  // 5: littlehorse.VariableAssignment.target_type:type_name -> littlehorse.TypeDefinition
	0,  // 6: littlehorse.VariableMutation.operation:type_name -> littlehorse.Operation
	2,  // 7: littlehorse.VariableMutation.rhs_assignment:type_name -> littlehorse.VariableAssignment
	22, // 8: littlehorse.VariableMutation.literal_value:type_name -> littlehorse.VariableValue
	16, // 9: littlehorse.VariableMutation.node_output:type_name -> littlehorse.VariableMutation.NodeOutputSource
	23, // 10: littlehorse.VariableDef.type:type_name -> littlehorse.VariableType
	22, // 11: littlehorse.VariableDef.default_value:type_name -> littlehorse.VariableValue
	5,  // 12: littlehorse.VariableDef.type_def:type_name -> littlehorse.TypeDefinition
	23, // 13: littlehorse.TypeDefinition.primitive_type:type_name -> littlehorse.VariableType
	24, // 14: littlehorse.TypeDefinition.struct_def_id:type_name -> littlehorse.StructDefId
	5,  // 15: littlehorse.ReturnType.return_type:type_name -> littlehorse.TypeDefinition
	18, // 16: littlehorse.UTActionTrigger.task:type_name -> littlehorse.UTActionTrigger.UTATask
	17, // 17: littlehorse.UTActionTrigger.cancel:type_name -> littlehorse.UTActionTrigger.UTACancel
	19, // 18: littlehorse.UTActionTrigger.reassign:type_name -> littlehorse.UTActionTrigger.UTAReassign
	2,  // 19: littlehorse.UTActionTrigger.delay_seconds:type_name -> littlehorse.VariableAssignment
	1,  // 20: littlehorse.UTActionTrigger.hook:type_name -> littlehorse.UTActionTrigger.UTHook
	25, // 21: littlehorse.TaskNode.task_def_id:type_name -> littlehorse.TaskDefId
	2,  // 22: littlehorse.TaskNode.dynamic_task:type_name -> littlehorse.VariableAssignment
	8,  // 23: littlehorse.TaskNode.exponential_backoff:type_name -> littlehorse.ExponentialBackoffRetryPolicy
	2,  // 24: littlehorse.TaskNode.variables:type_name -> littlehorse.VariableAssignment
	20, // 25: littlehorse.InlineStructDef.fields:type_name -> littlehorse.InlineStructDef.FieldsEntry
	5,  // 26: littlehorse.StructFieldDef.field_type:type_name -> littlehorse.TypeDefinition
	22, // 27: littlehorse.StructFieldDef.default_value:type_name -> littlehorse.VariableValue
	21, // 28: littlehorse.LHPath.path:type_name -> littlehorse.LHPath.Selector
	2,  // 29: littlehorse.VariableAssignment.FormatString.format:type_name -> littlehorse.VariableAssignment
	2,  // 30: littlehorse.VariableAssignment.FormatString.args:type_name -> littlehorse.VariableAssignment
	2,  // 31: littlehorse.VariableAssignment.Expression.lhs:type_name -> littlehorse.VariableAssignment
	0,  // 32: littlehorse.VariableAssignment.Expression.operation:type_name -> littlehorse.Operation
	2,  // 33: littlehorse.VariableAssignment.Expression.rhs:type_name -> littlehorse.VariableAssignment
	12, // 34: littlehorse.VariableMutation.NodeOutputSource.lh_path:type_name -> littlehorse.LHPath
	9,  // 35: littlehorse.UTActionTrigger.UTATask.task:type_name -> littlehorse.TaskNode
	...
	11, // 39: littlehorse.InlineStructDef.FieldsEntry.value:type_name -> littlehorse.StructFieldDef
