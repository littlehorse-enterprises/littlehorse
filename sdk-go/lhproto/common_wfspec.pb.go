...
func (UTActionTrigger_UTHook) EnumDescriptor() ([]byte, []int) {
	return file_common_wfspec_proto_rawDescGZIP(), []int{7, 0}
}
...
type VariableAssignment struct {
	...
	//	*VariableAssignment_StructBuilder
	//	*VariableAssignment_SizeOf_
	//	*VariableAssignment_MapBuilder
...
func (x *VariableAssignment) GetStructBuilder() *StructBuilder {
	if x, ok := x.GetSource().(*VariableAssignment_StructBuilder); ok {
		return x.StructBuilder
	}
	return nil
}

func (x *VariableAssignment) GetSizeOf() *VariableAssignment_SizeOf {
	if x, ok := x.GetSource().(*VariableAssignment_SizeOf_); ok {
		return x.SizeOf
	}
	return nil
}

func (x *VariableAssignment) GetMapBuilder() *MapBuilder {
	if x, ok := x.GetSource().(*VariableAssignment_MapBuilder); ok {
		return x.MapBuilder
	}
	return nil
}
...
type VariableAssignment_StructBuilder struct {
	// Builds a Struct using data available in the ThreadRun.
	StructBuilder *StructBuilder `protobuf:"bytes,9,opt,name=struct_builder,json=structBuilder,proto3,oneof"`
}
...
type VariableAssignment_SizeOf_ struct {
	...
	SizeOf *VariableAssignment_SizeOf `protobuf:"bytes,10,opt,name=size_of,json=sizeOf,proto3,oneof"`
}
...
func (*VariableAssignment_StructBuilder) isVariableAssignment_Source() {}

func (*VariableAssignment_SizeOf_) isVariableAssignment_Source() {}

func (*VariableAssignment_MapBuilder) isVariableAssignment_Source() {}
...
type StructBuilder struct {
	...
	Value *InlineStructBuilder `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
}

func (x *StructBuilder) Reset() {
	*x = StructBuilder{}
	if protoimpl.UnsafeEnabled {
...
func (x *StructBuilder) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StructBuilder) ProtoMessage() {}

func (x *StructBuilder) ProtoReflect() protoreflect.Message {
	mi := &file_common_wfspec_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StructBuilder.ProtoReflect.Descriptor instead.
func (*StructBuilder) Descriptor() ([]byte, []int) {
	return file_common_wfspec_proto_rawDescGZIP(), []int{1}
}

func (x *StructBuilder) GetStructDefId() *StructDefId {
	if x != nil {
...
func (x *StructBuilder) GetValue() *InlineStructBuilder {
	if x != nil {
		return x.Value
	}
	return nil
...
type InlineStructBuilder struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Determines the values for each field in the resulting InlineStruct.
	Fields map[string]*InlineStructFieldValue `protobuf:"bytes,1,rep,name=fields,proto3" json:"fields,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *InlineStructBuilder) Reset() {
	*x = InlineStructBuilder{}
	if protoimpl.UnsafeEnabled {
...
func (x *InlineStructBuilder) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InlineStructBuilder) ProtoMessage() {}

func (x *InlineStructBuilder) ProtoReflect() protoreflect.Message {
	mi := &file_common_wfspec_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InlineStructBuilder.ProtoReflect.Descriptor instead.
func (*InlineStructBuilder) Descriptor() ([]byte, []int) {
	return file_common_wfspec_proto_rawDescGZIP(), []int{2}
}

func (x *InlineStructBuilder) GetFields() map[string]*InlineStructFieldValue {
	if x != nil {
		return x.Fields
	}
	return nil
...
type InlineStructFieldValue struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*InlineStructFieldValue_SimpleValue
	//	*InlineStructFieldValue_SubStructure
	StructValue isInlineStructFieldValue_StructValue `protobuf_oneof:"struct_value"`
}

func (x *InlineStructFieldValue) Reset() {
	*x = InlineStructFieldValue{}
	if protoimpl.UnsafeEnabled {
...
func (x *InlineStructFieldValue) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InlineStructFieldValue) ProtoMessage() {}

func (x *InlineStructFieldValue) ProtoReflect() protoreflect.Message {
	mi := &file_common_wfspec_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InlineStructFieldValue.ProtoReflect.Descriptor instead.
func (*InlineStructFieldValue) Descriptor() ([]byte, []int) {
	return file_common_wfspec_proto_rawDescGZIP(), []int{3}
}

func (m *InlineStructFieldValue) GetStructValue() isInlineStructFieldValue_StructValue {
	if m != nil {
...
func (x *InlineStructFieldValue) GetSimpleValue() *VariableAssignment {
	if x, ok := x.GetStructValue().(*InlineStructFieldValue_SimpleValue); ok {
		return x.SimpleValue
	}
	return nil
}

func (x *InlineStructFieldValue) GetSubStructure() *InlineStructBuilder {
	if x, ok := x.GetStructValue().(*InlineStructFieldValue_SubStructure); ok {
		return x.SubStructure
	}
	return nil
}

type isInlineStructFieldValue_StructValue interface {
	isInlineStructFieldValue_StructValue()
}

type InlineStructFieldValue_SimpleValue struct {
	// Simple value that already exists in the context of the ThreadRun.
	SimpleValue *VariableAssignment `protobuf:"bytes,1,opt,name=simple_value,json=simpleValue,proto3,oneof"`
}

type InlineStructFieldValue_SubStructure struct {
	// Builds a nested sub-structure of a Struct.
	SubStructure *InlineStructBuilder `protobuf:"bytes,2,opt,name=sub_structure,json=subStructure,proto3,oneof"`
}

func (*InlineStructFieldValue_SimpleValue) isInlineStructFieldValue_StructValue() {}

func (*InlineStructFieldValue_SubStructure) isInlineStructFieldValue_StructValue() {}
...
func (x *MapBuilder) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MapBuilder) ProtoMessage() {}

func (x *MapBuilder) ProtoReflect() protoreflect.Message {
	mi := &file_common_wfspec_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MapBuilder.ProtoReflect.Descriptor instead.
func (*MapBuilder) Descriptor() ([]byte, []int) {
	return file_common_wfspec_proto_rawDescGZIP(), []int{4}
}

func (x *MapBuilder) GetEntries() []*MapBuilder_Entry {
	if x != nil {
		return x.Entries
	}
	return nil
...
func (x *MapBuilder) GetMapType() *InlineMapDef {
	if x != nil {
		return x.MapType
	}
	return nil
...
type VariableMutation struct {
	...
	LhsLhPath *LHPath `protobuf:"bytes,7,opt,name=lhs_lh_path,json=lhsLhPath,proto3,oneof" json:"lhs_lh_path,omitempty"`
...
func (x *VariableMutation) GetLhsLhPath() *LHPath {
	if x != nil {
		return x.LhsLhPath
	}
	return nil
...
type VariableAssignment_SizeOf struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The value whose size should be resolved.
	Operand *VariableAssignment `protobuf:"bytes,1,opt,name=operand,proto3" json:"operand,omitempty"`
}
...
func (x *VariableAssignment_SizeOf) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use VariableAssignment_SizeOf.ProtoReflect.Descriptor instead.
func (*VariableAssignment_SizeOf) Descriptor() ([]byte, []int) {
	return file_common_wfspec_proto_rawDescGZIP(), []int{0, 2}
}

func (x *VariableAssignment_SizeOf) GetOperand() *VariableAssignment {
	if x != nil {
		return x.Operand
	}
	return nil
...
type VariableAssignment_Expression struct {
	...
	//	*VariableAssignment_Expression_Comparator
	Operation isVariableAssignment_Expression_Operation `protobuf_oneof:"operation"`
...
func (*VariableAssignment_Expression) Descriptor() ([]byte, []int) {
	return file_common_wfspec_proto_rawDescGZIP(), []int{0, 3}
}
...
func (m *VariableAssignment_Expression) GetOperation() isVariableAssignment_Expression_Operation {
	if m != nil {
		return m.Operation
	}
	return nil
...
func (x *VariableAssignment_Expression) GetMutationType() VariableMutationType {
	if x, ok := x.GetOperation().(*VariableAssignment_Expression_MutationType); ok {
		return x.MutationType
	}
	return VariableMutationType_ASSIGN
}

func (x *VariableAssignment_Expression) GetComparator() Comparator {
	if x, ok := x.GetOperation().(*VariableAssignment_Expression_Comparator); ok {
		return x.Comparator
	}
...
type isVariableAssignment_Expression_Operation interface {
	isVariableAssignment_Expression_Operation()
}
...
type VariableAssignment_Expression_Comparator struct {
	Comparator Comparator `protobuf:"varint,4,opt,name=comparator,proto3,enum=littlehorse.Comparator,oneof"`
}

func (*VariableAssignment_Expression_MutationType) isVariableAssignment_Expression_Operation() {}

func (*VariableAssignment_Expression_Comparator) isVariableAssignment_Expression_Operation() {}

// A single dynamically-resolved key/value entry.
type MapBuilder_Entry struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Resolves to the key. Must resolve to a primitive type.
	Key *VariableAssignment `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	// Resolves to the value.
	Value *VariableAssignment `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
}

func (x *MapBuilder_Entry) Reset() {
	*x = MapBuilder_Entry{}
	if protoimpl.UnsafeEnabled {
...
func (x *MapBuilder_Entry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MapBuilder_Entry) ProtoMessage() {}

func (x *MapBuilder_Entry) ProtoReflect() protoreflect.Message {
	mi := &file_common_wfspec_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MapBuilder_Entry.ProtoReflect.Descriptor instead.
func (*MapBuilder_Entry) Descriptor() ([]byte, []int) {
	return file_common_wfspec_proto_rawDescGZIP(), []int{4, 0}
}

func (x *MapBuilder_Entry) GetKey() *VariableAssignment {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *MapBuilder_Entry) GetValue() *VariableAssignment {
	if x != nil {
		return x.Value
	}
	return nil
...
func (*UTActionTrigger_UTATask) Descriptor() ([]byte, []int) {
	return file_common_wfspec_proto_rawDescGZIP(), []int{7, 1}
}
...
func (*UTActionTrigger_UTAReassign) Descriptor() ([]byte, []int) {
	return file_common_wfspec_proto_rawDescGZIP(), []int{7, 2}
}
...
func (x *LHPath_Selector) Reset() {
	*x = LHPath_Selector{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_wfspec_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *LHPath_Selector) GetDynamic() *VariableAssignment {
	if x, ok := x.GetSelectorType().(*LHPath_Selector_Dynamic); ok {
		return x.Dynamic
	}
	return nil
}
...
type LHPath_Selector_Dynamic struct {
	// A selector value resolved from the current ThreadRun context.
	Dynamic *VariableAssignment `protobuf:"bytes,3,opt,name=dynamic,proto3,oneof"`
}
...
func (*LHPath_Selector_Dynamic) isLHPath_Selector_SelectorType() {}
...
var file_common_wfspec_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x0c, 0x6c, 0x69, 0x74, 0x65, 0x72, 0x61, 0x6c, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x53,
	...
	,
	...
	0x74, 0x52, 0x06, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x33, 0x0a, 0x04, 0x61, 0x72, 0x67,
	...
	,
	...
	0x6d, 0x65, 0x6e, 0x74, 0x52, 0x03, 0x6c, 0x68, 0x73, 0x12, 0x48, 0x0a, 0x0d, 0x6d, 0x75, 0x74,
	...
	,
	...
	0x66, 0x49, 0x64, 0x52, 0x0b, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x44, 0x65, 0x66, 0x49, 0x64,
	...
	,
	...
	,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x6d, 0x61, 0x70, 0x5f, 0x74,
	0x79, 0x70, 0x65, 0x22, 0xca, 0x04, 0x0a, 0x10, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65,
	...
	,
	...
	,
	...
	0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x6c, 0x68, 0x73, 0x5f, 0x6c, 0x68, 0x5f, 0x70, 0x61, 0x74, 0x68,
	0x22, 0xb9, 0x02, 0x0a, 0x0b, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x44, 0x65, 0x66,
	0x12, 0x32, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19,
	0x2e, 0x6c, 0x69, 0x74, 0x74, 0x6c, 0x65, 0x68, 0x6f, 0x72, 0x73, 0x65, 0x2e, 0x56, 0x61, 0x72,
	0x69, 0x61, 0x62, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x48, 0x00, 0x52, 0x04, 0x74, 0x79, 0x70,
	0x65, 0x88, 0x01, 0x01, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x44, 0x0a, 0x0d, 0x64, 0x65, 0x66, 0x61,
	...
	,
	...
	0x54, 0x61, 0x73, 0x6b, 0x48, 0x00, 0x52, 0x04, 0x74, 0x61, 0x73, 0x6b, 0x12, 0x40, 0x0a, 0x06,
	0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x6c,
	0x69, 0x74, 0x74, 0x6c, 0x65, 0x68, 0x6f, 0x72, 0x73, 0x65, 0x2e, 0x55, 0x54, 0x41, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x2e, 0x55, 0x54, 0x41, 0x43, 0x61,
	0x6e, 0x63, 0x65, 0x6c, 0x48, 0x00, 0x52, 0x06, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x12, 0x46,
	...
	,
	...
	,
	...
	,
	...
	0x6b, 0x44, 0x65, 0x66, 0x49, 0x64, 0x48, 0x00, 0x52, 0x09, 0x74, 0x61, 0x73, 0x6b, 0x44, 0x65,
	0x66, 0x49, 0x64, 0x12, 0x44, 0x0a, 0x0c, 0x64, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x5f, 0x74,
	0x61, 0x73, 0x6b, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x6c, 0x69, 0x74, 0x74,
	0x6c, 0x65, 0x68, 0x6f, 0x72, 0x73, 0x65, 0x2e, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65,
	0x41, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x48, 0x00, 0x52, 0x0b, 0x64, 0x79,
	0x6e, 0x61, 0x6d, 0x69, 0x63, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x27, 0x0a, 0x0f, 0x74, 0x69, 0x6d,
	...
	0x01, 0x28, 0x05, 0x52, 0x07, 0x72, 0x65, 0x74, 0x72, 0x69, 0x65, 0x73, 0x12, 0x60, 0x0a, 0x13,
	0x65, 0x78, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x5f, 0x62, 0x61, 0x63, 0x6b,
	0x6f, 0x66, 0x66, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x6c, 0x69, 0x74, 0x74,
	0x6c, 0x65, 0x68, 0x6f, 0x72, 0x73, 0x65, 0x2e, 0x45, 0x78, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74,
	0x69, 0x61, 0x6c, 0x42, 0x61, 0x63, 0x6b, 0x6f, 0x66, 0x66, 0x52, 0x65, 0x74, 0x72, 0x79, 0x50,
	0x6f, 0x6c, 0x69, 0x63, 0x79, 0x48, 0x01, 0x52, 0x12, 0x65, 0x78, 0x70, 0x6f, 0x6e, 0x65, 0x6e,
	0x74, 0x69, 0x61, 0x6c, 0x42, 0x61, 0x63, 0x6b, 0x6f, 0x66, 0x66, 0x88, 0x01, 0x01, 0x12, 0x3d,
	...
	,
	...
	0x45, 0x5f, 0x4b, 0x45, 0x59, 0x10, 0x08, 0x12, 0x07, 0x0a, 0x03, 0x41, 0x4e, 0x44, 0x10, 0x09,
	0x12, 0x06, 0x0a, 0x02, 0x4f, 0x52, 0x10, 0x0a, 0x12, 0x07, 0x0a, 0x03, 0x50, 0x4f, 0x57, 0x10,
	0x0b, 0x42, 0x4d, 0x0a, 0x1f, 0x69, 0x6f, 0x2e, 0x6c, 0x69, 0x74, 0x74, 0x6c, 0x65, 0x68, 0x6f,
...
var file_common_wfspec_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_common_wfspec_proto_goTypes = []interface{}{
	...
	(*VariableAssignment)(nil),                     // 2: littlehorse.VariableAssignment
	(*StructBuilder)(nil),                          // 3: littlehorse.StructBuilder
	(*InlineStructBuilder)(nil),                    // 4: littlehorse.InlineStructBuilder
	(*InlineStructFieldValue)(nil),                 // 5: littlehorse.InlineStructFieldValue
	(*MapBuilder)(nil),                             // 6: littlehorse.MapBuilder
	(*VariableMutation)(nil),                       // 7: littlehorse.VariableMutation
	(*VariableDef)(nil),                            // 8: littlehorse.VariableDef
	(*UTActionTrigger)(nil),                        // 9: littlehorse.UTActionTrigger
	(*ExponentialBackoffRetryPolicy)(nil),          // 10: littlehorse.ExponentialBackoffRetryPolicy
	(*TaskNode)(nil),                               // 11: littlehorse.TaskNode
	(*LHPath)(nil),                                 // 12: littlehorse.LHPath
	(*VariableAssignment_FormatString)(nil),        // 13: littlehorse.VariableAssignment.FormatString
	(*VariableAssignment_NodeOutputReference)(nil), // 14: littlehorse.VariableAssignment.NodeOutputReference
	(*VariableAssignment_SizeOf)(nil),              // 15: littlehorse.VariableAssignment.SizeOf
	(*VariableAssignment_Expression)(nil),          // 16: littlehorse.VariableAssignment.Expression
	nil,                                            // 17: littlehorse.InlineStructBuilder.FieldsEntry
	(*MapBuilder_Entry)(nil),                       // 18: littlehorse.MapBuilder.Entry
	...
	(*LHPath_Selector)(nil),                        // 23: littlehorse.LHPath.Selector
	(*VariableValue)(nil),                          // 24: littlehorse.VariableValue
	(*TypeDefinition)(nil),                         // 25: littlehorse.TypeDefinition
	(*StructDefId)(nil),                            // 26: littlehorse.StructDefId
	(*InlineMapDef)(nil),                           // 27: littlehorse.InlineMapDef
...
var file_common_wfspec_proto_depIdxs = []int32{
	12, // 0: littlehorse.VariableAssignment.lh_path:type_name -> littlehorse.LHPath
	24, // 1: littlehorse.VariableAssignment.literal_value:type_name -> littlehorse.VariableValue
	13, // 2: littlehorse.VariableAssignment.format_string:type_name -> littlehorse.VariableAssignment.FormatString
	14, // 3: littlehorse.VariableAssignment.node_output:type_name -> littlehorse.VariableAssignment.NodeOutputReference
	...
	15, // 6: littlehorse.VariableAssignment.size_of:type_name -> littlehorse.VariableAssignment.SizeOf
	6,  // 7: littlehorse.VariableAssignment.map_builder:type_name -> littlehorse.MapBuilder
	25, // 8: littlehorse.VariableAssignment.target_type:type_name -> littlehorse.TypeDefinition
	26, // 9: littlehorse.StructBuilder.struct_def_id:type_name -> littlehorse.StructDefId
	4,  // 10: littlehorse.StructBuilder.value:type_name -> littlehorse.InlineStructBuilder
	17, // 11: littlehorse.InlineStructBuilder.fields:type_name -> littlehorse.InlineStructBuilder.FieldsEntry
	2,  // 12: littlehorse.InlineStructFieldValue.simple_value:type_name -> littlehorse.VariableAssignment
	4,  // 13: littlehorse.InlineStructFieldValue.sub_structure:type_name -> littlehorse.InlineStructBuilder
	18, // 14: littlehorse.MapBuilder.entries:type_name -> littlehorse.MapBuilder.Entry
	27, // 15: littlehorse.MapBuilder.map_type:type_name -> littlehorse.InlineMapDef
	12, // 16: littlehorse.VariableMutation.lhs_lh_path:type_name -> littlehorse.LHPath
	0,  // 17: littlehorse.VariableMutation.operation:type_name -> littlehorse.VariableMutationType
	2,  // 18: littlehorse.VariableMutation.rhs_assignment:type_name -> littlehorse.VariableAssignment
	24, // 19: littlehorse.VariableMutation.literal_value:type_name -> littlehorse.VariableValue
	19, // 20: littlehorse.VariableMutation.node_output:type_name -> littlehorse.VariableMutation.NodeOutputSource
	28, // 21: littlehorse.VariableDef.type:type_name -> littlehorse.VariableType
	24, // 22: littlehorse.VariableDef.default_value:type_name -> littlehorse.VariableValue
	25, // 23: littlehorse.VariableDef.type_def:type_name -> littlehorse.TypeDefinition
	21, // 24: littlehorse.UTActionTrigger.task:type_name -> littlehorse.UTActionTrigger.UTATask
	20, // 25: littlehorse.UTActionTrigger.cancel:type_name -> littlehorse.UTActionTrigger.UTACancel
	22, // 26: littlehorse.UTActionTrigger.reassign:type_name -> littlehorse.UTActionTrigger.UTAReassign
	2,  // 27: littlehorse.UTActionTrigger.delay_seconds:type_name -> littlehorse.VariableAssignment
	1,  // 28: littlehorse.UTActionTrigger.hook:type_name -> littlehorse.UTActionTrigger.UTHook
	29, // 29: littlehorse.TaskNode.task_def_id:type_name -> littlehorse.TaskDefId
	2,  // 30: littlehorse.TaskNode.dynamic_task:type_name -> littlehorse.VariableAssignment
	10, // 31: littlehorse.TaskNode.exponential_backoff:type_name -> littlehorse.ExponentialBackoffRetryPolicy
	2,  // 32: littlehorse.TaskNode.variables:type_name -> littlehorse.VariableAssignment
	23, // 33: littlehorse.LHPath.path:type_name -> littlehorse.LHPath.Selector
	2,  // 34: littlehorse.VariableAssignment.FormatString.format:type_name -> littlehorse.VariableAssignment
	2,  // 35: littlehorse.VariableAssignment.FormatString.args:type_name -> littlehorse.VariableAssignment
	2,  // 36: littlehorse.VariableAssignment.SizeOf.operand:type_name -> littlehorse.VariableAssignment
	2,  // 37: littlehorse.VariableAssignment.Expression.lhs:type_name -> littlehorse.VariableAssignment
	0,  // 38: littlehorse.VariableAssignment.Expression.mutation_type:type_name -> littlehorse.VariableMutationType
	30, // 39: littlehorse.VariableAssignment.Expression.comparator:type_name -> littlehorse.Comparator
	2,  // 40: littlehorse.VariableAssignment.Expression.rhs:type_name -> littlehorse.VariableAssignment
	5,  // 41: littlehorse.InlineStructBuilder.FieldsEntry.value:type_name -> littlehorse.InlineStructFieldValue
	2,  // 42: littlehorse.MapBuilder.Entry.key:type_name -> littlehorse.VariableAssignment
	2,  // 43: littlehorse.MapBuilder.Entry.value:type_name -> littlehorse.VariableAssignment
	12, // 44: littlehorse.VariableMutation.NodeOutputSource.lh_path:type_name -> littlehorse.LHPath
	11, // 45: littlehorse.UTActionTrigger.UTATask.task:type_name -> littlehorse.TaskNode
	7,  // 46: littlehorse.UTActionTrigger.UTATask.mutations:type_name -> littlehorse.VariableMutation
	2,  // 47: littlehorse.UTActionTrigger.UTAReassign.user_id:type_name -> littlehorse.VariableAssignment
	2,  // 48: littlehorse.UTActionTrigger.UTAReassign.user_group:type_name -> littlehorse.VariableAssignment
	2,  // 49: littlehorse.LHPath.Selector.dynamic:type_name -> littlehorse.VariableAssignment
...
func file_common_wfspec_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_wfspec_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InlineStructBuilder); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_common_wfspec_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InlineStructFieldValue); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_common_wfspec_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
	...
	file_common_wfspec_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*VariableAssignment_StructBuilder)(nil),
		(*VariableAssignment_SizeOf_)(nil),
		(*VariableAssignment_MapBuilder)(nil),
	}
	file_common_wfspec_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*InlineStructFieldValue_SimpleValue)(nil),
		(*InlineStructFieldValue_SubStructure)(nil),
	}
	...
	file_common_wfspec_proto_msgTypes[21].OneofWrappers = []interface{}{
		(*LHPath_Selector_Key)(nil),
		(*LHPath_Selector_Index)(nil),
		(*LHPath_Selector_Dynamic)(nil),
	}
	type x struct{}
