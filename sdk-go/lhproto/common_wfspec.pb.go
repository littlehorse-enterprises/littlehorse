...
func (x *TypeDefinition) GetStruct() *StructDefId {
	if x, ok := x.GetDefinedType().(*TypeDefinition_Struct); ok {
		return x.Struct
	}
	return nil
}

func (x *TypeDefinition) GetInlineStruct() *InlineStructDef {
	if x, ok := x.GetDefinedType().(*TypeDefinition_InlineStruct); ok {
		return x.InlineStruct
	}
	return nil
}
...
type TypeDefinition_Struct struct {
	Struct *StructDefId `protobuf:"bytes,5,opt,name=struct,proto3,oneof"`
}

type TypeDefinition_InlineStruct struct {
	InlineStruct *InlineStructDef `protobuf:"bytes,6,opt,name=inline_struct,json=inlineStruct,proto3,oneof"`
}

func (*TypeDefinition_PrimitiveType) isTypeDefinition_DefinedType() {}

func (*TypeDefinition_Struct) isTypeDefinition_DefinedType() {}

func (*TypeDefinition_InlineStruct) isTypeDefinition_DefinedType() {}
...
var file_common_wfspec_proto_rawDesc = []byte{
	...
	0x0b, 0x0a, 0x09, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x64, 0x65, 0x66, 0x22, 0x81, 0x02, 0x0a,
	...
	,
	...
	0x75, 0x65, 0x2a, 0x98, 0x01, 0x0a, 0x14, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x4d,
...
var file_common_wfspec_proto_depIdxs = []int32{
	...
	21, // 6: littlehorse.VariableMutation.literal_value:type_name -> littlehorse.VariableValue
	16, // 7: littlehorse.VariableMutation.node_output:type_name -> littlehorse.VariableMutation.NodeOutputSource
	22, // 8: littlehorse.VariableDef.type:type_name -> littlehorse.VariableType
	21, // 9: littlehorse.VariableDef.default_value:type_name -> littlehorse.VariableValue
	6,  // 10: littlehorse.VariableDef.type_def:type_name -> littlehorse.TypeDefinition
	22, // 11: littlehorse.TypeDefinition.primitive_type:type_name -> littlehorse.VariableType
	23, // 12: littlehorse.TypeDefinition.struct:type_name -> littlehorse.StructDefId
	11, // 13: littlehorse.TypeDefinition.inline_struct:type_name -> littlehorse.InlineStructDef
...
func file_common_wfspec_proto_init() {
	...
	file_common_wfspec_proto_msgTypes[3].OneofWrappers = []interface{}{
		...
		(*TypeDefinition_InlineStruct)(nil),
	}
