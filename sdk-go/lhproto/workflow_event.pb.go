...
type WorkflowEventDef struct {
	...
	Type PrimitiveType `protobuf:"varint,3,opt,name=type,proto3,enum=littlehorse.PrimitiveType" json:"type,omitempty"`
}
...
func (x *WorkflowEventDef) GetType() PrimitiveType {
	if x != nil {
		return x.Type
	}
...
var file_workflow_event_proto_rawDesc = []byte{
	...
	0x75, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xae, 0x01, 0x0a, 0x0d, 0x57, 0x6f,
	...
	0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xae, 0x01, 0x0a, 0x10, 0x57,
	...
	0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x6c, 0x69, 0x74, 0x74,
	0x6c, 0x65, 0x68, 0x6f, 0x72, 0x73, 0x65, 0x2e, 0x50, 0x72, 0x69, 0x6d, 0x69, 0x74, 0x69, 0x76,
	0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x42, 0x49, 0x0a, 0x1f, 0x69,
...
var file_workflow_event_proto_goTypes = []interface{}{
	...
	(PrimitiveType)(0),            // 6: littlehorse.PrimitiveType
}
var file_workflow_event_proto_depIdxs = []int32{
	...
	6, // 5: littlehorse.WorkflowEventDef.type:type_name -> littlehorse.PrimitiveType
