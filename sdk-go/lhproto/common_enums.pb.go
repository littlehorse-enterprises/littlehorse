...
const (
	...
	AggregationType_LATENCY AggregationType = 1
)
...
type MetricRecordingLevel int32

const (
	MetricRecordingLevel_INFO  MetricRecordingLevel = 0 // Collect non-intrusive defaults
	MetricRecordingLevel_NONE  MetricRecordingLevel = 1 // Collect no metrics unless explicitly configured
	MetricRecordingLevel_DEBUG MetricRecordingLevel = 2 // Collect detailed/expensive metrics (e.g. flamegraphs)
)

// Enum value maps for MetricRecordingLevel.
var (
	MetricRecordingLevel_name = map[int32]string{
		0: "INFO",
		1: "NONE",
		2: "DEBUG",
	}
	MetricRecordingLevel_value = map[string]int32{
		"INFO":  0,
		"NONE":  1,
		"DEBUG": 2,
	}
...
func (x MetricRecordingLevel) Enum() *MetricRecordingLevel {
	p := new(MetricRecordingLevel)
	*p = x
	return p
}

func (x MetricRecordingLevel) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MetricRecordingLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_common_enums_proto_enumTypes[5].Descriptor()
}

func (MetricRecordingLevel) Type() protoreflect.EnumType {
	return &file_common_enums_proto_enumTypes[5]
}

func (x MetricRecordingLevel) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MetricRecordingLevel.Descriptor instead.
func (MetricRecordingLevel) EnumDescriptor() ([]byte, []int) {
...
const (
	MetricEntityType_METRIC_WF_RUN        MetricEntityType = 0
	MetricEntityType_METRIC_TASK_RUN      MetricEntityType = 1
	MetricEntityType_METRIC_USER_TASK_RUN MetricEntityType = 2
	MetricEntityType_METRIC_NODE_RUN      MetricEntityType = 3
	MetricEntityType_METRIC_THREAD_RUN    MetricEntityType = 4
)

// Enum value maps for MetricEntityType.
var (
	MetricEntityType_name = map[int32]string{
		0: "METRIC_WF_RUN",
		1: "METRIC_TASK_RUN",
		2: "METRIC_USER_TASK_RUN",
		3: "METRIC_NODE_RUN",
		4: "METRIC_THREAD_RUN",
	}
	MetricEntityType_value = map[string]int32{
		"METRIC_WF_RUN":        0,
		"METRIC_TASK_RUN":      1,
...
func (x MetricEntityType) Enum() *MetricEntityType {
	p := new(MetricEntityType)
	*p = x
	return p
}

func (x MetricEntityType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MetricEntityType) Descriptor() protoreflect.EnumDescriptor {
	return file_common_enums_proto_enumTypes[6].Descriptor()
}

func (MetricEntityType) Type() protoreflect.EnumType {
	return &file_common_enums_proto_enumTypes[6]
}

func (x MetricEntityType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MetricEntityType.Descriptor instead.
func (MetricEntityType) EnumDescriptor() ([]byte, []int) {
...
var file_common_enums_proto_rawDesc = []byte{
	...
	0x02, 0x2a, 0x29, 0x0a, 0x0f, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x09, 0x0a, 0x05, 0x43, 0x4f, 0x55, 0x4e, 0x54, 0x10, 0x00, 0x12,
	0x0b, 0x0a, 0x07, 0x4c, 0x41, 0x54, 0x45, 0x4e, 0x43, 0x59, 0x10, 0x01, 0x2a, 0x35, 0x0a, 0x14,
	...
	,
	...
	,
...
var file_common_enums_proto_enumTypes = make([]protoimpl.EnumInfo, 9)
var file_common_enums_proto_goTypes = []interface{}{
	...
	(AggregationType)(0),      // 4: littlehorse.AggregationType
	(MetricRecordingLevel)(0), // 5: littlehorse.MetricRecordingLevel
	(MetricEntityType)(0),     // 6: littlehorse.MetricEntityType
	(VariableType)(0),         // 7: littlehorse.VariableType
	(LHErrorType)(0),          // 8: littlehorse.LHErrorType
}
