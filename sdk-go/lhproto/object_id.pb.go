...
type MetricSpecId_Node struct {
	Node *NodeReference `protobuf:"bytes,1,opt,name=node,proto3,oneof"`
}
...
type MetricSpecId_ThreadSpec struct {
	ThreadSpec *ThreadSpecReference `protobuf:"bytes,3,opt,name=thread_spec,json=threadSpec,proto3,oneof"`
}
...
var file_object_id_proto_rawDesc = []byte{
	...
	0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0xc9, 0x01, 0x0a, 0x0c, 0x4d, 0x65, 0x74, 0x72, 0x69,
	0x63, 0x53, 0x70, 0x65, 0x63, 0x49, 0x64, 0x12, 0x30, 0x0a, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x18,
	...
	0x65, 0x48, 0x00, 0x52, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x12, 0x35, 0x0a, 0x0a, 0x77, 0x66, 0x5f,
	...
	0x65, 0x63, 0x49, 0x64, 0x48, 0x00, 0x52, 0x08, 0x77, 0x66, 0x53, 0x70, 0x65, 0x63, 0x49, 0x64,
	0x12, 0x43, 0x0a, 0x0b, 0x74, 0x68, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x6c, 0x69, 0x74, 0x74, 0x6c, 0x65, 0x68, 0x6f,
	0x72, 0x73, 0x65, 0x2e, 0x54, 0x68, 0x72, 0x65, 0x61, 0x64, 0x53, 0x70, 0x65, 0x63, 0x52, 0x65,
	0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x48, 0x00, 0x52, 0x0a, 0x74, 0x68, 0x72, 0x65, 0x61,
	0x64, 0x53, 0x70, 0x65, 0x63, 0x42, 0x0b, 0x0a, 0x09, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e,
	0x63, 0x65, 0x22, 0x93, 0x02, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x49, 0x64, 0x12,
	...
	0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x6c, 0x69, 0x74, 0x74,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x42, 0x4d, 0x0a, 0x1f, 0x69, 0x6f, 0x2e, 0x6c,
...
var file_object_id_proto_goTypes = []interface{}{
	...
	(AggregationType)(0),          // 27: littlehorse.AggregationType
}
var file_object_id_proto_depIdxs = []int32{
	...
	20, // 19: littlehorse.MetricSpecId.node:type_name -> littlehorse.NodeReference
	0,  // 20: littlehorse.MetricSpecId.wf_spec_id:type_name -> littlehorse.WfSpecId
	21, // 21: littlehorse.MetricSpecId.thread_spec:type_name -> littlehorse.ThreadSpecReference
	22, // 22: littlehorse.MetricId.metric_spec_id:type_name -> littlehorse.MetricSpecId
	26, // 23: littlehorse.MetricId.window_length:type_name -> google.protobuf.Duration
	24, // 24: littlehorse.MetricId.window_start:type_name -> google.protobuf.Timestamp
	27, // 25: littlehorse.MetricId.aggregation_type:type_name -> littlehorse.AggregationType
