...
var file_wf_run_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xbb, 0x09, 0x0a, 0x05, 0x57, 0x66, 0x52, 0x75, 0x6e, 0x12, 0x24, 0x0a, 0x02,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x1a, 0xbc,
	...
	0x74, 0x69, 0x6e, 0x67, 0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x72, 0x75, 0x6e, 0x1a, 0x61, 0x0a,
	0x17, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62,
	...
	0x74, 0x70, 0x75, 0x74, 0x22, 0x4a, 0x0a, 0x11, 0x49, 0x6e, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65,
	0x54, 0x68, 0x72, 0x65, 0x61, 0x64, 0x52, 0x75, 0x6e, 0x12, 0x35, 0x0a, 0x0a, 0x74, 0x68, 0x72,
	0x65, 0x61, 0x64, 0x5f, 0x72, 0x75, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e,
	0x6c, 0x69, 0x74, 0x74, 0x6c, 0x65, 0x68, 0x6f, 0x72, 0x73, 0x65, 0x2e, 0x54, 0x68, 0x72, 0x65,
	0x61, 0x64, 0x52, 0x75, 0x6e, 0x52, 0x09, 0x74, 0x68, 0x72, 0x65, 0x61, 0x64, 0x52, 0x75, 0x6e,
...
var file_wf_run_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_wf_run_proto_goTypes = []interface{}{
	...
	nil,                                     // 16: littlehorse.WfRun.MigrationVariablesEntry
	(*WfRunId)(nil),                         // 17: littlehorse.WfRunId
	(*WfSpecId)(nil),                        // 18: littlehorse.WfSpecId
	(LHStatus)(0),                           // 19: littlehorse.LHStatus
	(*timestamppb.Timestamp)(nil),           // 20: google.protobuf.Timestamp
	(*WorkflowMigrationPlanId)(nil),         // 21: littlehorse.WorkflowMigrationPlanId
	(*ExternalEventId)(nil),                 // 22: littlehorse.ExternalEventId
	(*VariableValue)(nil),                   // 23: littlehorse.VariableValue
	(*NodeRunId)(nil),                       // 24: littlehorse.NodeRunId
	(*MigrationVars)(nil),                   // 25: littlehorse.MigrationVars
}
var file_wf_run_proto_depIdxs = []int32{
	17, // 0: littlehorse.WfRun.id:type_name -> littlehorse.WfRunId
	18, // 1: littlehorse.WfRun.wf_spec_id:type_name -> littlehorse.WfSpecId
	18, // 2: littlehorse.WfRun.old_wf_spec_versions:type_name -> littlehorse.WfSpecId
	19, // 3: littlehorse.WfRun.status:type_name -> littlehorse.LHStatus
	20, // 4: littlehorse.WfRun.start_time:type_name -> google.protobuf.Timestamp
	20, // 5: littlehorse.WfRun.end_time:type_name -> google.protobuf.Timestamp
	...
	21, // 10: littlehorse.WfRun.workflow_migration_plan_id:type_name -> littlehorse.WorkflowMigrationPlanId
	16, // 11: littlehorse.WfRun.migration_variables:type_name -> littlehorse.WfRun.MigrationVariablesEntry
	18, // 12: littlehorse.ThreadRun.wf_spec_id:type_name -> littlehorse.WfSpecId
	19, // 13: littlehorse.ThreadRun.status:type_name -> littlehorse.LHStatus
	20, // 14: littlehorse.ThreadRun.start_time:type_name -> google.protobuf.Timestamp
	20, // 15: littlehorse.ThreadRun.end_time:type_name -> google.protobuf.Timestamp
	14, // 16: littlehorse.ThreadRun.halt_reasons:type_name -> littlehorse.ThreadHaltReason
	22, // 17: littlehorse.ThreadRun.interrupt_trigger_id:type_name -> littlehorse.ExternalEventId
	4,  // 18: littlehorse.ThreadRun.failure_being_handled:type_name -> littlehorse.FailureBeingHandled
	0,  // 19: littlehorse.ThreadRun.type:type_name -> littlehorse.ThreadType
	23, // 20: littlehorse.ThreadRun.output:type_name -> littlehorse.VariableValue
	2,  // 21: littlehorse.InactiveThreadRun.thread_run:type_name -> littlehorse.ThreadRun
	22, // 22: littlehorse.PendingInterrupt.external_event_id:type_name -> littlehorse.ExternalEventId
	22, // 23: littlehorse.PendingInterruptHaltReason.external_event_id:type_name -> littlehorse.ExternalEventId
	11, // 24: littlehorse.ThreadHaltReason.parent_halted:type_name -> littlehorse.ParentHalted
	12, // 25: littlehorse.ThreadHaltReason.interrupted:type_name -> littlehorse.Interrupted
	7,  // 26: littlehorse.ThreadHaltReason.pending_interrupt:type_name -> littlehorse.PendingInterruptHaltReason
	8,  // 27: littlehorse.ThreadHaltReason.pending_failure:type_name -> littlehorse.PendingFailureHandlerHaltReason
	9,  // 28: littlehorse.ThreadHaltReason.handling_failure:type_name -> littlehorse.HandlingFailureHaltReason
	13, // 29: littlehorse.ThreadHaltReason.manual_halt:type_name -> littlehorse.ManualHalt
	10, // 30: littlehorse.ThreadHaltReason.halted_by_parent:type_name -> littlehorse.HaltedByParentNodeHaltReason
	24, // 31: littlehorse.WfRun.ParentTriggerReference.triggering_node_run:type_name -> littlehorse.NodeRunId
	24, // 32: littlehorse.WfRun.ParentTriggerReference.waiting_node_run:type_name -> littlehorse.NodeRunId
	25, // 33: littlehorse.WfRun.MigrationVariablesEntry.value:type_name -> littlehorse.MigrationVars
