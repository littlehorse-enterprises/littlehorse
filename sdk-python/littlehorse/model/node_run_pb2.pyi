...
class NodeRun(_message.Message):
    __slots__ = ("id", "wf_spec_id", "failure_handler_ids", "status", "arrival_time", "end_time", "thread_spec_name", "node_name", "error_message", "failures", "task", "external_event", "entrypoint", "exit", "start_thread", "wait_for_threads", "sleep", "user_task", "start_multiple_threads", "throw_event", "wait_for_condition")
    ...
    wait_for_threads: WaitForThreadsRun
    sleep: SleepNodeRun
...
class WaitForConditionRun(_message.Message):
    __slots__ = ()
...
class WaitForThreadsRun(_message.Message):
    ...
    class WaitForThread(_message.Message):
        ...
        def __init__(self, thread_end_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., thread_status: _Optional[_Union[_common_enums_pb2.LHStatus, str]] = ..., thread_run_number: _Optional[int] = ..., waiting_status: _Optional[_Union[WaitForThreadsRun.WaitingThreadStatus, str]] = ..., failure_handler_thread_run_id: _Optional[int] = ...) -> None: ...
...
class ExternalEventNodeRun(_message.Message):
    __slots__ = ("external_event_def_id", "event_time", "external_event_id", "timed_out", "correlation_key", "mask_correlation_key")
    ...
    def __init__(self, external_event_def_id: _Optional[_Union[_object_id_pb2.ExternalEventDefId, _Mapping]] = ..., event_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., external_event_id: _Optional[_Union[_object_id_pb2.ExternalEventId, _Mapping]] = ..., timed_out: _Optional[bool] = ..., correlation_key: _Optional[str] = ..., mask_correlation_key: _Optional[bool] = ...) -> None: ...
...
class SleepNodeRun(_message.Message):
    ...
    matured: bool
    def __init__(self, maturation_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., matured: _Optional[bool] = ...) -> None: ...
