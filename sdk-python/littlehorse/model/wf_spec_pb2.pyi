...
class WaitForConditionNode(_message.Message):
    ...
    condition: LegacyEdgeCondition
    def __init__(self, condition: _Optional[_Union[LegacyEdgeCondition, _Mapping]] = ...) -> None: ...
...
class LegacyEdgeCondition(_message.Message):
    ...
    comparator: _common_wfspec_pb2.Operation
    left: _common_wfspec_pb2.VariableAssignment
    right: _common_wfspec_pb2.VariableAssignment
    def __init__(self, comparator: _Optional[_Union[_common_wfspec_pb2.Operation, str]] = ..., left: _Optional[_Union[_common_wfspec_pb2.VariableAssignment, _Mapping]] = ..., right: _Optional[_Union[_common_wfspec_pb2.VariableAssignment, _Mapping]] = ...) -> None: ...

class Edge(_message.Message):
    __slots__ = ("sink_node_name", "legacy_condition", "variable_mutations")
    ...
    def __init__(self, sink_node_name: _Optional[str] = ..., legacy_condition: _Optional[_Union[LegacyEdgeCondition, _Mapping]] = ..., variable_mutations: _Optional[_Iterable[_Union[_common_wfspec_pb2.VariableMutation, _Mapping]]] = ...) -> None: ...
