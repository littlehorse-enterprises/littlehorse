...
class PutPrincipalRequest(_message.Message):
    __slots__ = ["id", "acls", "tenant_id", "default_tenant_id", "overwrite"]
    ID_FIELD_NUMBER: _ClassVar[int]
    ACLS_FIELD_NUMBER: _ClassVar[int]
    ...
    default_tenant_id: str
    overwrite: bool
    def __init__(self, id: _Optional[str] = ..., acls: _Optional[_Iterable[_Union[ServerACL, _Mapping]]] = ..., tenant_id: _Optional[_Iterable[str]] = ..., default_tenant_id: _Optional[str] = ..., overwrite: bool = ...) -> None: ...
