...
class VariableAssignment(_message.Message):
    __slots__ = ["json_path", "variable_name", "literal_value", "format_string", "node_output", "expression", "cast_to"]
    ...
    CAST_TO_FIELD_NUMBER: _ClassVar[int]
    json_path: str
    variable_name: str
