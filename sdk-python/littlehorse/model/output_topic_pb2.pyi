...
class OutputTopicRecord(_message.Message):
    __slots__ = ["timestamp", "task_run", "workflow_event", "wf_run", "user_task_run", "variable", "external_event", "data_nugget"]
    ...
    DATA_NUGGET_FIELD_NUMBER: _ClassVar[int]
