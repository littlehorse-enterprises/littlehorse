...
class ScheduleStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    STARTED: _ClassVar[ScheduleStatus]
    SUSPENDED: _ClassVar[ScheduleStatus]
STARTED: ScheduleStatus
SUSPENDED: ScheduleStatus

class ScheduledWfRun(_message.Message):
    __slots__ = ["id", "wf_spec_id", "variables", "parent_wf_run_id", "cron_expression", "status", "created_at"]
