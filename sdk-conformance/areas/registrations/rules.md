...
besides its WfSpec, meaning the side-registration protos and the
required-names sets. As everywhere, **the fixtures are the authority**;
this prose restates them. A divergence here never errors: events silently
stop matching across SDKs.
...
document: the four registration gestures and the six accessors. It is
reflection-verified at mint.
...
variants, base is the nearest do-nothing neighbor, and the base and
feature documents must differ.
