...
export const TaskExecutionMetrics = ({windows= 16, lastWindowStart=moment().toDate(), type="HOURS_2"}:Props) => {
        ...
        <>
            <div className="grid md:grid-cols-2 xs:grid-cols-1">
                ...
                <div className="text-right buttons-group">
                    <Button onClick={() => setChart('tasks')} className={`btn-dark ${chart === 'tasks' && "active-dark"}`}>Tasks</Button>
