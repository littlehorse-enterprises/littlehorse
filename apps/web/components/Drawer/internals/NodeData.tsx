  ...
  return (
    <div className="drawer__nodeData">
      ...
      <div className="grid-3">
        {props.scheduled &&  <p className="drawer__nodeData__header">SCHEDULED</p>}
        {props.scheduled &&  <p className="drawer__nodeData__data">{props.scheduled ? moment(props.scheduled).format('MMMM DD, HH:mm:ss') : ''}</p>}
