...
public class WfSpec extends POSTable<WfSpecPbOrBuilder> {
    ...
    @JsonIgnore public void handlePost(
        POSTable<WfSpecPbOrBuilder> old, LHGlobalMetaStores dbClient, LHConfig config
    ...
    private void validate(LHGlobalMetaStores dbClient, LHConfig config) throws LHValidationError {
