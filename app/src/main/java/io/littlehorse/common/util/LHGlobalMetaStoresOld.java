...
public class LHGlobalMetaStoresOld {
    ...
    public LHGlobalMetaStoresOld(final ProcessorContext<String, GenericOutput> ctx) {
        wfSpecStore =
    ...
    public LHGlobalMetaStoresOld(ApiStreamsContext streams) {
