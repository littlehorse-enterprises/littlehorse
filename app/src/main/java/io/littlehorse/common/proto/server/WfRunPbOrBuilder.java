...
public interface WfRunPbOrBuilder extends
   ...
   */
  java.util.List<io.littlehorse.common.proto.server.ThreadRunPb> 
      getThreadRunsList();
  /**
   * <code>repeated .lh_proto.ThreadRunPb thread_runs = 8;</code>
   */
  io.littlehorse.common.proto.server.ThreadRunPb getThreadRuns(int index);
  /**
   * <code>repeated .lh_proto.ThreadRunPb thread_runs = 8;</code>
   */
   ...
   * <code>repeated .lh_proto.ThreadRunPb thread_runs = 8;</code>
   */
  java.util.List<? extends io.littlehorse.common.proto.server.ThreadRunPbOrBuilder> 
      getThreadRunsOrBuilderList();
  /**
   * <code>repeated .lh_proto.ThreadRunPb thread_runs = 8;</code>
   */
  io.littlehorse.common.proto.server.ThreadRunPbOrBuilder getThreadRunsOrBuilder(
      int index);
}
