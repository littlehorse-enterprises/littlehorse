...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 34: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              indexEntries_ = new java.util.ArrayList<io.littlehorse.common.proto.IndexEntryPb>();
              mutable_bitField0_ |= 0x00000001;
            }
            indexEntries_.add(
                input.readMessage(io.littlehorse.common.proto.IndexEntryPb.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.littlehorse.common.proto.Server.internal_static_lh_proto_GETableEntryPb_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.littlehorse.common.proto.Server.internal_static_lh_proto_GETableEntryPb_fieldAccessorTable
  ...
  private java.util.List<io.littlehorse.common.proto.IndexEntryPb> indexEntries_;
  /**
   * <code>repeated .lh_proto.IndexEntryPb index_entries = 4;</code>
   */
  @java.lang.Override
  public java.util.List<io.littlehorse.common.proto.IndexEntryPb> getIndexEntriesList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends io.littlehorse.common.proto.IndexEntryPbOrBuilder> 
   ...
   */
  @java.lang.Override
  public io.littlehorse.common.proto.IndexEntryPb getIndexEntries(int index) {
   ...
   */
  @java.lang.Override
  public io.littlehorse.common.proto.IndexEntryPbOrBuilder getIndexEntriesOrBuilder(
      int index) {
    return indexEntries_.get(index);
  }
  ...
  public static final class Builder extends
    ...
    private void ensureIndexEntriesIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        indexEntries_ = new java.util.ArrayList<io.littlehorse.common.proto.IndexEntryPb>(indexEntries_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.littlehorse.common.proto.IndexEntryPb, io.littlehorse.common.proto.IndexEntryPb.Builder, io.littlehorse.common.proto.IndexEntryPbOrBuilder> indexEntriesBuilder_;
    ...
    public Builder setIndexEntries(
        int index, io.littlehorse.common.proto.IndexEntryPb value) {
      if (indexEntriesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setIndexEntries(
        int index, io.littlehorse.common.proto.IndexEntryPb.Builder builderForValue) {
      if (indexEntriesBuilder_ == null) {
        ensureIndexEntriesIsMutable();
     ...
     * <code>repeated .lh_proto.IndexEntryPb index_entries = 4;</code>
     */
    public Builder addIndexEntries(io.littlehorse.common.proto.IndexEntryPb value) {
      if (indexEntriesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addIndexEntries(
        io.littlehorse.common.proto.IndexEntryPb.Builder builderForValue) {
      if (indexEntriesBuilder_ == null) {
        ensureIndexEntriesIsMutable();
    ...
    public Builder addAllIndexEntries(
        java.lang.Iterable<? extends io.littlehorse.common.proto.IndexEntryPb> values) {
      if (indexEntriesBuilder_ == null) {
        ensureIndexEntriesIsMutable();
     ...
     * <code>repeated .lh_proto.IndexEntryPb index_entries = 4;</code>
     */
    public io.littlehorse.common.proto.IndexEntryPb.Builder getIndexEntriesBuilder(
        int index) {
     ...
     * <code>repeated .lh_proto.IndexEntryPb index_entries = 4;</code>
     */
    public io.littlehorse.common.proto.IndexEntryPb.Builder addIndexEntriesBuilder() {
      return getIndexEntriesFieldBuilder().addBuilder(
          io.littlehorse.common.proto.IndexEntryPb.getDefaultInstance());
    }
    /**
     * <code>repeated .lh_proto.IndexEntryPb index_entries = 4;</code>
     */
    public io.littlehorse.common.proto.IndexEntryPb.Builder addIndexEntriesBuilder(
        int index) {
      return getIndexEntriesFieldBuilder().addBuilder(
          index, io.littlehorse.common.proto.IndexEntryPb.getDefaultInstance());
    }
    /**
     * <code>repeated .lh_proto.IndexEntryPb index_entries = 4;</code>
     */
    public java.util.List<io.littlehorse.common.proto.IndexEntryPb.Builder> 
         getIndexEntriesBuilderList() {
      return getIndexEntriesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        io.littlehorse.common.proto.IndexEntryPb, io.littlehorse.common.proto.IndexEntryPb.Builder, io.littlehorse.common.proto.IndexEntryPbOrBuilder> 
        getIndexEntriesFieldBuilder() {
      if (indexEntriesBuilder_ == null) {
