...
public class LHConstants {
  ...
  public static final String REPLICATION_FACTOR_KEY =
    "LHORSE_REPLICATION_FACTOR";
  public static final String TASK_PARTITIONS_KEY = "LHORSE_TASK_PARTITIONS";
  public static final String CLUSTER_PARTITIONS_KEY =
    "LHORSE_CLUSTER_PARTITIONS";
  public static final String NUM_STREAM_THREADS_KEY =
    "LHORSE_NUM_STREAM_THREADS";
  ...
  public static final String NUM_WORKER_THREADS_KEY =
    "LHORSE_NUM_WORKER_THREADS";
  ...
  public static final String SCHED_WF_RUN_STORE_NAME =
    "Scheduler_WfRunState_Store";
  public static final String SCHED_VARIABLE_STORE_NAME =
    "Scheduler_Variable_Store";
  ...
  public static final String KAFKA_STATE_DIR_KEY =
    "LHORSE_KAFKA_STREAMS_STATE_DIR";
